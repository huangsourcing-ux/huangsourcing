...
export const resourceGuideCategories: ResourceGuideCategory[] = [
  {
    ...
    links: [
      ...
      },
      {
        ...
        label: 'How to verify UL certification from a China supplier',
      },
      {
  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        label: 'Slide playset entrapment and shipment checklist',
      },
      {
      ...
      },
      {
        ...
        label: 'Electric kettle evidence and shipment checklist',
      },
      {
        href: miniFridgeChecksChinaArticleHref,
        label: 'Mini fridge evidence and shipment checklist',
      },
      {
        href: hairDryerBrushChecksChinaArticleHref,
        label: 'Hair dryer brush evidence and shipment checklist',
      },
      {
      ...
      },
      {
        ...
        label: 'Toddler tower evidence and shipment checklist',
      },
      {
