export const handbagChemicalChecksChinaArticleHref = '/handbag-chemical-checks-china'
...
export const babyWalkerChecksChinaArticleHref =
  '/baby-walker-checks-china'
export const babySwingChecksChinaArticleHref =
  '/baby-swing-checks-china'
export const ceilingFanChecksChinaArticleHref =
...
export const grillBrushChecksChinaArticleHref =
...
export const retractableGateChecksChinaArticleHref =
  '/retractable-gate-checks-china'
export const busyBoardToyChecksChinaArticleHref =
  '/busy-board-toy-checks-china'
...
export const miniFridgeChecksChinaArticleHref =
  '/mini-fridge-checks-china'
export const hairDryerBrushChecksChinaArticleHref =
...
export const childrensSleepwearChecksChinaArticleHref =
  '/childrens-sleepwear-checks-china'
...
export const toddlerTowerChecksChinaArticleHref =
  '/toddler-tower-checks-china'
...
export const usCustomsEnforcementChinaImportsArticleHref =
  '/us-customs-enforcement-china-imports-2026'
export const usSection232MetalTariffsChinaSourcingArticleHref =
  '/us-section-232-metal-tariffs-china-sourcing-2026'
...
export const euForcedLabourRegulationChinaArticleHref =
  '/eu-forced-labour-regulation-china-sourcing-2027'
...
export const verifyUlCertificationChinaArticleHref =
  '/verify-ul-certification-china'
