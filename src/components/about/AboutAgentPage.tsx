  ...
  return (
    <main className="min-h-screen bg-[#f6f7f8] text-[#1a1a2e] antialiased">
      ...
      <article className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
        ...
        <p className="mt-2 text-center text-sm font-medium text-slate-500 sm:text-base">{a.h1Sub}</p>
        <p className="mx-auto mt-6 max-w-2xl text-center text-lg font-semibold text-slate-800">{a.intro}</p>
        ...
        <div className="mt-12 max-w-none space-y-0">
          ...
          <h2 className="mt-10 text-xl font-extrabold text-slate-900">{a.s2Title}</h2>
          <p className="mt-2 text-base font-medium leading-relaxed text-slate-700 sm:text-lg">
            {a.s2Before}
            <mark
              className={cn(
          ...
          <h2 className="mt-10 text-xl font-extrabold text-slate-900">{a.s3Title}</h2>
          <p className="mt-2 text-base font-medium leading-relaxed text-slate-700 sm:text-lg">
            {a.s3Intro}
          </p>
          ...
          <h2 className="mt-10 text-xl font-extrabold text-slate-900">{a.s4Title}</h2>
          <p className="mt-2 text-base font-medium leading-relaxed text-slate-700 sm:text-lg">
            {a.s4Body}
          </p>
        </div>
        ...
        <div className="mt-12 rounded-3xl border border-slate-200 bg-white p-6 shadow-lg sm:p-8">
          <p className="text-center text-base font-semibold text-slate-800">{a.cta}</p>
