...
import {
  electricKettleChecksChinaArticle,
  makeElectricKettleChecksChinaArticleJsonLd,
} from '@/lib/electric-kettle-checks-china-article'
...
export function ElectricKettleChecksChinaArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makeElectricKettleChecksChinaArticleJsonLd()} />
      <SiteBreadcrumbs
        ...
        <div className="hs-container grid gap-10 py-10 sm:py-14 lg:grid-cols-12 lg:py-16">
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="electric_kettle_checks_china_article_hero"
          ...
          <Reveal className="lg:col-span-6" delayMs={120}>
            ...
            <p className="hs-muted mt-3 text-xs leading-5">
              Neutral AI illustration of a generic China-side kettle check; not a
              photograph or evidence from any cited public case.
            </p>
            <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {['Exact Model', 'Hot-Liquid Path', 'Evidence', 'Release'].map((item) => (
                <a
          ...
          <article className="min-w-0 lg:col-span-8">
            <Reveal>
              ...
              <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
                What should buyers check before electric kettles leave China?
              </h2>
              <p className="hs-muted mt-4 text-base leading-7">
                Match the exact production model, lid, latch, handle, steam path,
                spout, base, controls, ratings, cord, plug, labels, instructions, and
                claims to qualified evidence and an approved reference. Inspect sampled
                goods and cartons for identity and visible conformity. Hold every
                unresolved model or lot instead of treating a visual pass or brief boil
                demonstration as proof against spills, steam release, burns, or
                electrical hazards.
              </p>
            ...
            <Reveal as="section" className="mt-12 scroll-mt-24" id="release-checklist">
              ...
              <p className="hs-muted mt-4 text-base leading-7">
                ...
                into a hot-liquid, pressure, strength, electrical, food-contact,
                endurance, certification, importer-filing, or safety guarantee.
              </p>
                ...
                {article.checkGroups.map((group) => (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <Plug aria-hidden className="size-5 text-[var(--hs-accent)]" />
                  ...
                  {section.id === 'why-current' ? (
                    <p className="hs-muted mt-5 text-sm leading-6">
                      ...
                      <a
                        ...
                        target="_blank"
                      >
                        independent Hong Kong coverage
                      </a>
                      .
                    </p>
                  ) : null}
                  {section.id === 'hot-liquid-evidence' ? (
                    <p className="hs-muted mt-5 text-sm leading-6">
                      Compare the current case with the separate{' '}
                      <a
                        className="hs-text-link"
                        ...
                        target="_blank"
                      >
                        CPSC BLONGKY kettle warning
                      </a>{' '}
                      for another documented steam, hot-water, and lid-mechanism failure
                      pattern. Keep the named models, dates, incidents, and remedies
                      separate.
                    </p>
                  ) : null}
                  {section.id === 'claims-labels' ? (
                    <p className="hs-muted mt-5 text-sm leading-6">
                      ...
                      <a
                        ...
                        target="_blank"
                      >
                        CPSC general-use product certification guidance
                      </a>
                      , then verify any claimed certification record at the issuing
                      body&apos;s official source and map it to the exact production model.
                    </p>
                  ) : null}
                  {section.id === 'test-boundary' ? (
                    <p className="hs-muted mt-5 text-sm leading-6">
                      CPSC&apos;s current{' '}
                      <a
                        className="hs-text-link"
      ...
      <section className="hs-section-soft" id="decision-table">
        <div className="hs-container hs-section">
          <Reveal className="max-w-3xl">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Turn kettle evidence into a payment or pickup decision.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Record the exact cleared model and lot and every open condition. A pass
              should never conceal unverified lid or handle construction, hot-liquid
              controls, certification scope, inaccessible stock, mixed components, or
      ...
      <EvidenceBasisSection
        ...
        intro="This guide combines current and earlier CPSC kettle records, independent reporting, an official China trade-information summary, and current CPSC certification and eFiling guidance with the exact-model, hot-liquid-control, physical-product, warning, packaging, correction, and release evidence a buyer can organize before goods leave China."
      ...
      <section className="hs-section-white scroll-mt-24" id="public-case">
        <div className="hs-container hs-section max-w-4xl">
          <Reveal>
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Balbali HP-300E warning: a hot-liquid containment lesson.
            </h2>
            <div className="hs-muted mt-4 grid gap-4 text-base leading-7">
              <p>
                <strong className="text-[var(--hs-text)]">What happened:</strong> On
                August 6, 2026, CPSC warned consumers to stop using Balbali portable
                electric kettles, model HP-300E. The agency said the kettles could
                pressurize and release hot steam or liquid unexpectedly, reported 52
                incidents and 20 injuries including third-degree burns, and stated that
                the importer had not agreed to an acceptable recall.
              </p>
              <p>
                ...
                identifies the exact model, China origin, hazard description, incident
                and injury counts, online sales channels, and remedy status. The page
                does not publish the complete design history, test file, root-cause
                analysis, or production quality records for every kettle.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">Buyer lesson:</strong> Freeze
                the complete hot-liquid path—not only the thermostat or a
                marketplace claim. Put lid and latch retention, handle attachment,
                venting, spout, seals, shutoff, boil-dry protection, base, controls,
                warnings, exact model, and production change history into the qualified
                evidence and pre-shipment plan.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">
                  Why the earlier cases still matter:
                </strong>{' '}
                The{' '}
                <a
                  className="hs-text-link"
                  ...
                  target="_blank"
                >
                  May 2026 Zwilling recall
                </a>{' '}
                documented handle loosening or separation in different China-made
                models; the{' '}
                <a
                  className="hs-text-link"
                  href="https://www.cpsc.gov/Warnings/2026/CPSC-Warns-Consumers-to-Immediately-Stop-Using-Portable-Electric-Car-Kettles-Due-to-Risk-of-Serious-Burn-Injury-Distributed-by-BLONGKY"
                  ...
                  target="_blank"
                >
                  November 2025 BLONGKY warning
                </a>{' '}
                documented steam or hot-water release and lid-mechanism failure in a
                portable car kettle. Different failure points can lead to the same buyer
                decision: verify the complete reviewed model and confirm mass
                production still matches before release.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">
                  Limits of comparison:
                </strong>{' '}
                The cited records do not prove every China-made electric kettle,
                supplier, factory, or lot has the same defect. Huang Sourcing had no
                role in the cases, and a sampled China-side inspection cannot reproduce
                qualified pressure, steam, strength, abnormal-operation, electrical,
                endurance, or food-contact testing or certify a kettle as safe.
              </p>
              <p className="text-sm">
                Cross-check the Zwilling case in the{' '}
                <a
                  className="hs-text-link"
                  ...
                  target="_blank"
                >
                  China Ministry of Commerce WTO/FTA information summary
                </a>
                .
              </p>
            </div>
        ...
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-2">
          ...
          >
            ...
            <div className="mt-5 grid gap-4 text-sm leading-6 text-[var(--hs-muted)]">
              <p>
                Name the exact cleared model, capacity, ratings, lid and handle
                versions, control version, factory, lot, cartons, quantities, evidence
                version, certification record, inspection sample, open conditions,
                correction status, and responsible release owner.
              </p>
              <p>
                If a failed or changed lot is corrected, require traceable segregation,
                qualified redesign or retest decisions, revised files, repeat
                inspection, and a new written release. Do not overwrite the original
                mismatch record.
              </p>
            </div>
          </Reveal>
        ...
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <p className="hs-muted mt-3 text-base leading-7">
              ...
              from hot-liquid, electrical, food-contact, certification, regulatory,
              importer, and end-use responsibilities.
            </p>
          </Reveal>
          ...
          <Reveal className="rounded-[var(--hs-radius)] bg-[var(--hs-navy)] p-7 text-white shadow-[var(--hs-shadow-lg)] sm:p-9">
            <div className="grid gap-7 lg:grid-cols-12 lg:items-center">
              <div className="lg:col-span-8">
                <div className="flex items-center gap-3">
                  <Thermometer aria-hidden className="size-7 text-[var(--hs-accent)]" />
                ...
                <p className="mt-3 max-w-3xl text-base leading-7 text-white/80">
                  Share the model list, lid and handle specifications, hot-liquid and
                  control evidence, reports, certification files, labels, instructions,
              ...
              <div className="flex flex-col gap-3 lg:col-span-4">
                <ContactAgentButton
                  analyticsLabel="Check electric kettles before shipment"
                  analyticsLocation="electric_kettle_checks_china_article_final_cta"
        ...
        <div className="hs-container hs-section">
          <Reveal>
            ...
            <p className="hs-muted mt-3 max-w-3xl text-sm leading-6">
              Public records, independent reporting, and current guidance checked
              August 7, 2026 Beijing time. Links are descriptive so buyers can inspect
              the dates, exact products, scope, evidence, and limitations directly.
            </p>
