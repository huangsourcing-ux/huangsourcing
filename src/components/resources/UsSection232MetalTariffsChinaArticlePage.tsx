...
import {
  makeUsSection232MetalTariffsChinaSourcingArticleJsonLd,
  usSection232MetalTariffsChinaSourcingArticle,
} from '@/lib/us-section-232-metal-tariffs-china-sourcing-2026-article'
...
export function UsSection232MetalTariffsChinaArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makeUsSection232MetalTariffsChinaSourcingArticleJsonLd()} />
      <SiteBreadcrumbs
        ...
        <div className="hs-container grid gap-10 py-10 sm:py-14 lg:grid-cols-12 lg:py-16">
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="us_section_232_metal_tariffs_article_hero"
          ...
          <Reveal className="lg:col-span-6" delayMs={120}>
            ...
            <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {['HTS', 'Metals', 'Invoice', 'Broker'].map((item) => (
                <a
          ...
          <article className="min-w-0 lg:col-span-8">
            <Reveal>
              ...
              <p className="hs-muted mt-4 text-base leading-7">
                Build a broker-ready file that connects each SKU to product scope,
                metal content, material evidence, invoice wording, origin facts,
                valuation support, carton evidence, and release instructions before
            ...
            >
              ...
              <p className="hs-muted mt-4 text-base leading-7">
                The check does not make customs legal decisions. It organizes the
                product and supplier facts the importer and broker need before entry
                positions become harder to support.
              </p>
      ...
      <EvidenceDecisionMatrix
        id="decision-table"
        intro="Use this table to decide whether Section 232 metal evidence is ready enough for payment, pickup, broker review, or a supplier correction hold."
        rows={article.decisionRows}
        title="Turn metal tariff evidence gaps into a release decision."
      />

      <EvidenceBasisSection
        className="hs-section-white"
        intro="This guide is based on official U.S. Section 232 source context, then narrowed to the product, metal, supplier, invoice, origin, value, packing, broker, and shipment evidence that can be checked before goods leave China."
      ...
      <section className="hs-section-soft" id="source-notes">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Verify the tariff regime, then check the shipment evidence.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              These sources explain the Section 232 context. They do not replace
              broker, customs, product-compliance, or legal advice.
            </p>
          </Reveal>
      ...
      <section className="hs-section-white" id="documents">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <p className="hs-muted mt-3 text-base leading-7">
              Send final references where possible. Draft chats and partial supplier
              screenshots usually miss the details a broker needs.
            </p>
          </Reveal>
      ...
      <section className="hs-section-soft" id="red-flags">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <p className="hs-muted mt-3 text-base leading-7">
              Pause payment or pickup when the supplier evidence conflicts with the
              product, metal-content, invoice, origin, valuation, or broker record.
            </p>
          </Reveal>
          <Reveal className="lg:col-span-8">
        ...
        <div className="hs-container hs-section max-w-4xl">
          <Reveal>
            ...
            <p className="hs-muted mt-3 text-base leading-7">
              ...
              cannot decide whether Section 232 applies or what duty should be paid.
            </p>
      ...
      <section className="hs-section-soft">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Build tariff evidence into the shipment decision.
            </h2>
          </Reveal>
          <div className="grid gap-3 md:grid-cols-2 lg:col-span-8">
          ...
          <Reveal className="hs-cta-band px-6 py-10 text-white sm:px-10 lg:flex lg:items-center lg:justify-between lg:gap-10">
            <div className="relative">
              ...
              <h2 className="mt-3 text-3xl font-extrabold">
                Check product, metal, invoice, origin, value, and broker evidence
                before release.
              </h2>
              <p className="mt-3 max-w-2xl text-base leading-7 text-slate-300">
                Send the product list, supplier records, material evidence, invoice
                drafts, packing records, broker notes, tariff concerns, and shipment
                deadline before final approval.
              </p>
            </div>
            <ContactAgentButton
              analyticsLabel={article.primaryCta.label}
              analyticsLocation="us_section_232_metal_tariffs_article_final"
