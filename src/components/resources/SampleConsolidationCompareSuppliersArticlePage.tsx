...
import {
  makeSampleConsolidationCompareSuppliersArticleJsonLd,
  sampleConsolidationCompareSuppliersArticle,
} from '@/lib/sample-consolidation-compare-suppliers-article'
...
export function SampleConsolidationCompareSuppliersArticlePage() {
  const whatsappHref = buildWhatsAppHref(
    sampleConsolidationCompareSuppliersArticle.whatsappMessage,
  )
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <SiteBreadcrumbs
        currentPath={sampleConsolidationCompareSuppliersArticle.href}
        items={[
          { label: 'China sourcing risk guides', href: '/china-sourcing-risk-guides' },
          { label: sampleConsolidationCompareSuppliersArticle.title },
        ]}
      />
      ...
      <section className="hs-hero">
        <div className="hs-container grid gap-10 py-10 sm:py-14 lg:grid-cols-12 lg:py-16">
          <Reveal className="min-w-0 lg:col-span-6">
            <p className="hs-eyebrow">{sampleConsolidationCompareSuppliersArticle.eyebrow}</p>
            <h1 className="mt-4 max-w-4xl text-balance text-4xl font-extrabold text-[var(--hs-text)] sm:text-5xl">
              {sampleConsolidationCompareSuppliersArticle.h1}
            </h1>
            <p className="hs-muted mt-5 max-w-3xl text-base leading-7 sm:text-lg sm:leading-8">
              {sampleConsolidationCompareSuppliersArticle.intro}
            </p>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="sample_consolidation_compare_suppliers_article_hero"
                className="hs-btn-primary h-12 px-6 text-sm sm:px-8"
                href={whatsappHref}
                size="lg"
                variant="default"
              >
                {sampleConsolidationCompareSuppliersArticle.primaryCta.label}
              </ContactAgentButton>
              <Button
                asChild
                ...
                variant="outline"
              >
                <a href={sampleConsolidationCompareSuppliersArticle.secondaryCta.href}>
                  {sampleConsolidationCompareSuppliersArticle.secondaryCta.label}
                </a>
              </Button>
            </div>
          </Reveal>
            ...
            <div className="overflow-hidden rounded-[var(--hs-radius)] border border-[var(--hs-border)] bg-[var(--hs-bg-soft)] shadow-[var(--hs-shadow-md)]">
              <div className="relative aspect-video">
                <Image
                  ...
                  src={sampleConsolidationCompareSuppliersArticle.image.src}
                />
              </div>
            </div>
            <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {['Receive', 'Label', 'Compare', 'Forward'].map((item) => (
                <a
                  ...
                  key={item}
                >
                  <span className="block text-xs uppercase text-[var(--hs-accent)]">Sample</span>
          ...
          <aside className="lg:col-span-4">
            <div className="hs-card sticky top-24 bg-[var(--hs-bg-soft)] p-5">
              ...
              <nav aria-label="Article table of contents" className="mt-5 grid gap-2">
                {sampleConsolidationCompareSuppliersArticle.tableOfContents.map((item) => (
                  <a
          ...
          <article className="min-w-0 lg:col-span-8">
            <Reveal>
              ...
              <p className="hs-muted mt-4 text-base leading-7">
                It puts supplier samples in one China-side workflow: receive, label,
                photograph, compare visible checkpoints, decide which samples deserve
                forwarding, and move shortlisted suppliers to verification when needed.
              </p>
              <div className="mt-6 grid gap-3 sm:grid-cols-2">
                {sampleConsolidationCompareSuppliersArticle.quickChecks.map((item, index) => (
                  <div
            ...
            <div className="mt-12 grid gap-12">
              {sampleConsolidationCompareSuppliersArticle.sections.map((section, index) => (
                <Reveal
                  as="section"
      ...
      <section className="hs-section-soft" id="decision-table">
        <div className="hs-container hs-section">
          <Reveal className="max-w-3xl">
            <p className="hs-eyebrow">Sample decision table</p>
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              What was checked and what the buyer can decide.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Sample consolidation is useful when the output is a decision, not just a
              parcel forwarding task. Each check should lead to a clear next action.
            </p>
          </Reveal>
          <div className="mt-8 overflow-hidden rounded-[var(--hs-radius)] border border-[var(--hs-border)] bg-white shadow-[var(--hs-shadow-sm)]">
            ...
            {sampleConsolidationCompareSuppliersArticle.decisionRows.map((row) => (
              <div
      ...
      <section className="hs-section-white" id="documents">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <p className="hs-muted mt-3 text-base leading-7">
              Clear supplier and tracking details keep the sample comparison clean. The
              more precise the buyer list is, the less risk there is of mixing samples.
            </p>
          </Reveal>
          <Reveal className="lg:col-span-8">
            <BulletList items={sampleConsolidationCompareSuppliersArticle.whatToSend} />
          </Reveal>
        </div>
      </section>
      ...
      <section className="hs-section-soft" id="red-flags">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <p className="hs-muted mt-3 text-base leading-7">
              These signals do not automatically disqualify a supplier, but they mean the
              buyer should slow down before deposit or supplier selection.
            </p>
          </Reveal>
          <Reveal className="lg:col-span-8">
            <BulletList items={sampleConsolidationCompareSuppliersArticle.redFlags} />
          </Reveal>
        </div>
      </section>
      ...
      <section className="hs-section-white" id="limits">
        <div className="hs-container hs-section max-w-4xl">
          <Reveal>
            ...
            <p className="hs-muted mt-3 text-base leading-7">
              Sample consolidation improves comparison evidence before supplier selection.
              It does not turn a sample into a guarantee for mass production.
            </p>
            <BulletList items={sampleConsolidationCompareSuppliersArticle.scopeLimits} />
          </Reveal>
        </div>
      </section>
      ...
      <section className="hs-section-soft">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Move from sample comparison to the right sourcing decision.
            </h2>
          </Reveal>
          <div className="grid gap-3 md:grid-cols-2 lg:col-span-8">
            {sampleConsolidationCompareSuppliersArticle.relatedLinks.map((link, index) => (
              <Link
      ...
      <section className="hs-section-white" id="faq">
        <div className="hs-container hs-section max-w-4xl">
          ...
          <div className="mt-6 grid gap-3">
            {sampleConsolidationCompareSuppliersArticle.faqs.map((faq, index) => (
              <Reveal
                as="article"
          ...
          <Reveal className="hs-cta-band px-6 py-10 text-white sm:px-10 lg:flex lg:items-center lg:justify-between lg:gap-10">
            <div className="relative">
              <div className="flex items-center gap-3">
                ...
                <p className="text-sm font-extrabold text-red-200">Before supplier selection</p>
              </div>
              <h2 className="mt-3 text-3xl font-extrabold">
                Compare samples before the factory choice becomes deposit risk.
              </h2>
              <p className="mt-3 max-w-2xl text-base leading-7 text-slate-300">
                Send supplier names, tracking numbers, product requirements, comparison
                points, and the decision you need after the samples arrive.
              </p>
            </div>
            <ContactAgentButton
              analyticsLabel={sampleConsolidationCompareSuppliersArticle.primaryCta.label}
              analyticsLocation="sample_consolidation_compare_suppliers_article_final"
