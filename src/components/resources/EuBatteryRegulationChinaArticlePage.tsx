...
import {
  euBatteryRegulationChinaArticle,
  makeEuBatteryRegulationChinaArticleJsonLd,
} from '@/lib/eu-battery-regulation-china-sourcing-2026-article'
...
export function EuBatteryRegulationChinaArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makeEuBatteryRegulationChinaArticleJsonLd()} />
      <SiteBreadcrumbs
        ...
        <div className="hs-container grid gap-10 py-10 sm:py-14 lg:grid-cols-12 lg:py-16">
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="eu_battery_regulation_article_hero"
          ...
          <Reveal className="lg:col-span-6" delayMs={120}>
            ...
            <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {['Battery ID', 'Labels', 'QR', 'Files'].map((item) => (
                <a
          ...
          <article className="min-w-0 lg:col-span-8">
            <Reveal>
              ...
              <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
                What should buyers check before EU-bound battery goods ship?
              </h2>
              <p className="hs-muted mt-4 text-base leading-7">
                Check whether the actual battery, battery-containing product, label,
                QR plan, declaration, test file, transport record, and importer handoff
                match the buyer-approved evidence plan before cartons leave China.
              </p>
            ...
            <Reveal as="section" className="mt-12 scroll-mt-24" id="battery-checklist">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="mt-1 text-3xl font-extrabold text-[var(--hs-text)]">
                    EU Battery Regulation readiness checklist
                  </h2>
                </div>
              </div>
              <p className="hs-muted mt-4 text-base leading-7">
                The check is practical: identify every battery in the order, tie it to
                the product and carton records, then compare visible evidence and
                supplier files with the EU importer&apos;s approved plan.
              </p>
      ...
      <EvidenceDecisionMatrix
        id="decision-table"
        intro="Use this table to decide whether battery evidence is ready enough for final payment, supplier correction, specialist review, or a hold before pickup."
        rows={article.decisionRows}
        title="Turn battery evidence into a shipment release decision."
      />

      <EvidenceBasisSection
        className="hs-section-white"
        intro="This guide is based on official EU battery source context, then narrowed to the battery identity, label, QR, supplier-document, and importer-handoff evidence that can be checked while goods are still in China."
        ...
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <p className="hs-muted mt-3 text-base leading-7">
              These sources explain the Battery Regulation, labelling, CE marking,
              QR, passport, and due diligence context. They do not replace
              product-specific EU compliance, transport, marketplace, customs, or
              legal advice.
            </p>
          </Reveal>
        ...
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-5 text-3xl font-extrabold text-[var(--hs-text)]">
              What to send before the China-side battery evidence check.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Send battery references and responsibility notes so the report can
              compare physical evidence against the files the EU team expects to use.
            </p>
          </Reveal>
      ...
      <section className="hs-section-soft" id="red-flags">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-5 text-3xl font-extrabold text-[var(--hs-text)]">
              Battery evidence red flags before shipment.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Pause payment or pickup when battery identity, labels, QR data, files,
              and physical cartons cannot be tied to the same approved order.
            </p>
          </Reveal>
          <Reveal className="lg:col-span-8">
      ...
      <section className="hs-section-white" id="scope-limits">
        <div className="hs-container hs-section max-w-4xl">
          <Reveal>
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              A China-side check is not EU battery conformity approval.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              The report can show what was visible and provided before shipment. It
              cannot decide whether the battery is legally compliant, properly
              registered, passport-ready, safely transportable, or accepted by an EU
              marketplace.
            </p>
      ...
      <section className="hs-section-soft">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Connect battery evidence to the shipment decision.
            </h2>
          </Reveal>
          <div className="grid gap-3 md:grid-cols-2 lg:col-span-8">
          ...
          <Reveal className="hs-cta-band px-6 py-10 text-white sm:px-10 lg:flex lg:items-center lg:justify-between lg:gap-10">
            <div className="relative">
              <div className="flex items-center gap-2 text-sm font-extrabold text-red-200">
                <Globe2 aria-hidden className="size-4" /> Before EU-bound battery goods leave China
              </div>
              <h2 className="mt-3 text-3xl font-extrabold">
                Check batteries, labels, QR plans, and supplier files while correction is still practical.
              </h2>
              <p className="mt-3 max-w-2xl text-base leading-7 text-slate-300">
                Send the SKU list, battery files, label artwork, QR instructions,
                declarations, test records, carton data, and release deadline before
                final shipment approval.
              </p>
            </div>
            <ContactAgentButton
              analyticsLabel={article.primaryCta.label}
              analyticsLocation="eu_battery_regulation_article_final"
