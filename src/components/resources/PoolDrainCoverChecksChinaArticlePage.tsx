...
import {
  makePoolDrainCoverChecksChinaArticleJsonLd,
  poolDrainCoverChecksChinaArticle,
} from '@/lib/pool-drain-cover-checks-china-article'
...
export function PoolDrainCoverChecksChinaArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makePoolDrainCoverChecksChinaArticleJsonLd()} />
      <SiteBreadcrumbs
        ...
        <div className="hs-container grid gap-10 py-10 sm:py-14 lg:grid-cols-12 lg:py-16">
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="pool_drain_cover_checks_china_article_hero"
          ...
          <Reveal className="lg:col-span-6" delayMs={120}>
            ...
            <p className="hs-muted mt-3 text-xs leading-5">
              Neutral illustration of generic drain-cover samples on a quality-control
              bench; not a product photo or evidence from the cited recalls.
            </p>
            <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {['Model', 'Markings', 'Evidence', 'Release'].map((item) => (
                <a
          ...
          <article className="min-w-0 lg:col-span-8">
            <Reveal>
              ...
              <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
                What should buyers check before pool drain covers leave China?
              </h2>
              <p className="hs-muted mt-4 text-base leading-7">
                Match each exact cover model and production lot to qualified evidence,
                permanent product markings, approved dimensions and fasteners,
                installation and maintenance instructions, packaging, and carton
                identity. Hold package-only, unlabeled, mixed, changed, or unsupported
                covers instead of treating appearance as proof of VGBA compliance.
              </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="mt-1 text-3xl font-extrabold text-[var(--hs-text)]">
                    Pool drain cover release checklist
                  </h2>
                </div>
              </div>
              <p className="hs-muted mt-4 text-base leading-7">
                This checklist connects technical files to sampled mass production and
                pack-out. It does not turn a visual inspection into certification,
                hydraulic design, site selection, code approval, or installation
                authorization.
              </p>
                ...
                {article.checkGroups.map((group) => (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <Gauge aria-hidden className="size-5 text-[var(--hs-accent)]" />
                ...
                >
                  ...
                  {section.id === 'why-current' ? (
                    <p className="hs-muted mt-5 text-sm leading-6">
                      ...
                      <a
                        className="hs-text-link"
                        href="https://www.cpsc.gov/Recall-Products/Swimming-Pools"
                        rel="noreferrer"
                        target="_blank"
                      >
                        CPSC swimming-pool recall record
                      </a>
                      , and{' '}
                      <a
                        className="hs-text-link"
                        ...
                        target="_blank"
                      >
                        independent July 2026 coverage
                      </a>
                      .
                    </p>
                  ) : null}
                  {section.id === 'markings' ? (
                    <p className="hs-muted mt-5 text-sm leading-6">
                      Compare the approved marking plan with CPSC&apos;s{' '}
                      <a
                        className="hs-text-link"
                        ...
                        target="_blank"
                      >
                        public pool or spa drain cover checklist
                      </a>{' '}
                      and the specific certified standard scope selected by the
                      responsible parties.
                    </p>
                  ) : null}
                  {section.id === 'certificate-evidence' ? (
                    <p className="hs-muted mt-5 text-sm leading-6">
                      CPSC&apos;s current{' '}
                      <a
                        className="hs-text-link"
                        ...
                        target="_blank"
                      >
                        pool and spa drain cover business guidance
                      </a>{' '}
                      explains the rule and GCC citation. Use the{' '}
                      <Link className="hs-text-link" href="/verify-china-lab-test-report">
                        China laboratory report verification guide
                      </Link>{' '}
                      for issuer, sample, model, and source checks.
                    </p>
                  ) : null}
                  {section.id === 'installation-boundary' ? (
                    <p className="hs-muted mt-5 text-sm leading-6">
                      The Pool &amp; Hot Tub Alliance&apos;s{' '}
                      <a
                        className="hs-text-link"
                        ...
                        target="_blank"
                      >
                        ANSI/APSP/ICC-16 standard overview
                      </a>{' '}
                      describes the marking, instruction, material, physical-test, and
                      flow-rating scope; it does not replace the final site-specific
                      review.
                    </p>
                  ) : null}
                </Reveal>
      ...
      <section className="hs-section-soft scroll-mt-24" id="decision-table">
        <div className="hs-container hs-section">
          <Reveal className="max-w-3xl">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Turn drain-cover evidence into a payment or pickup decision.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Record the exact cleared models, lots, cartons, evidence versions, and
              open conditions. A pass should never conceal missing product identity,
              unsupported marks, mixed production, or unresolved professional
              selection and installation decisions.
            </p>
          </Reveal>
      ...
      <EvidenceBasisSection
        ...
        intro="This guide combines current CPSC recalls, CPSC compliance and business guidance, independent reporting, and certification-body context with the model, marking, document, physical-product, instruction, packaging, correction, and release evidence a buyer can organize before goods leave China."
      ...
      <section className="hs-section-white scroll-mt-24" id="public-case">
        <div className="hs-container hs-section max-w-4xl">
          <Reveal>
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              OeyUoc recall: package identity was not product identity.
            </h2>
            <div className="hs-muted mt-4 grid gap-4 text-base leading-7">
              <p>
                <strong className="text-[var(--hs-text)]">What happened:</strong> On
                July 23, 2026, CPSC announced the recall of about 404 OeyUoc replacement
                pool drain covers sold on Amazon from April through June 2026. The
                notice identifies Shenzhen Yuanxinxiang Trade Co., Ltd. as the China
                retailer and China as the country of manufacture.
              </p>
              <p>
                ...
                says the product violated VGBA entrapment-protection standards and had
                no labeling or product identification on the cover itself. A clear
                package carried order and model-like identifiers and “MADE IN CHINA,”
                and two screws were included.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">Buyer lesson:</strong> Freeze
                the exact model before production, verify the certificate and standard
                scope at their claimed sources, and inspect permanent marks, dimensions,
                fasteners, instructions, packages, and lots. A labeled bag and familiar
                hardware do not establish the identity or performance of the cover
                inside.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">
                ...
                The recall does not prove that every China-made drain cover or supplier
                has the same defect. No incidents or injuries were reported in the
                notice. Huang Sourcing had no role in the case, and a pre-shipment
                inspection cannot reproduce certified entrapment tests or approve a
                final pool installation.
              </p>
            </div>
          </Reveal>
        </div>
        ...
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-2">
          ...
          >
            ...
            <div className="mt-5 grid gap-4 text-sm leading-6 text-[var(--hs-muted)]">
              <p>
                Name the exact cleared model, manufacturer, factory, lot, cartons,
                quantities, evidence version, certificate record, inspection sample,
              ...
              <p>
                ...
                record and require traceable segregation, qualified redesign or retest
                decisions, revised files, repeat inspection, and a new written release.
              </p>
            </div>
          </Reveal>
        </div>
        ...
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <p className="hs-muted mt-3 text-base leading-7">
              ...
              from technical, certification, regulatory, importer, hydraulic, and
          ...
          <Reveal className="rounded-[var(--hs-radius)] bg-[var(--hs-navy)] p-7 text-white shadow-[var(--hs-shadow-lg)] sm:p-9">
            <div className="grid gap-7 lg:grid-cols-12 lg:items-center">
              <div className="lg:col-span-8">
                <div className="flex items-center gap-3">
                  <Waves aria-hidden className="size-7 text-[var(--hs-accent)]" />
                ...
                <p className="mt-3 max-w-3xl text-base leading-7 text-white/80">
                  Share the model list, drawings, certificate and report files, approved
                  markings, dimensions, fasteners, instructions, packaging, carton map,
                  and payment deadline. Huang Sourcing can scope a practical China-side
                  comparison before balance payment or pickup.
                </p>
              </div>
              <div className="flex flex-col gap-3 lg:col-span-4">
                <ContactAgentButton
                  analyticsLabel="Check pool drain covers before shipment"
                  analyticsLocation="pool_drain_cover_checks_china_article_final_cta"
        ...
        <div className="hs-container hs-section">
          <Reveal>
            ...
            <p className="hs-muted mt-3 max-w-3xl text-sm leading-6">
              Public records and current guidance checked July 31, 2026 Beijing time.
              Links are descriptive so buyers can inspect the event date, exact product,
              rule, scope, evidence, and limitations directly.
            </p>
