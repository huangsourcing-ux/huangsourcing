...
import {
  babyLoungerChecksChinaArticle,
  makeBabyLoungerChecksChinaArticleJsonLd,
} from '@/lib/baby-lounger-checks-china-article'
...
export function BabyLoungerChecksChinaArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makeBabyLoungerChecksChinaArticleJsonLd()} />
      <SiteBreadcrumbs
        ...
        <div className="hs-container grid gap-10 py-10 sm:py-14 lg:grid-cols-12 lg:py-16">
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="baby_lounger_checks_china_article_hero"
          ...
          <Reveal className="lg:col-span-6" delayMs={120}>
            ...
            <p className="hs-muted mt-3 text-xs leading-5">
              ...
              product photograph, laboratory result, or evidence from the cited public
              case.
            </p>
          ...
          <article className="min-w-0 lg:col-span-8">
            <Reveal>
              ...
              <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
                What should buyers check before baby loungers leave China?
              </h2>
              <p className="hs-muted mt-4 text-base leading-7">
                Match every model, material version, factory, production date, lot,
                and carton to a documented product route, qualified test evidence,
                certificate data, approved construction, warnings, tracking,
                registration materials, package claims, and shipment identity. Hold
                generic, changed, mixed, mislabeled, out-of-tolerance, or untraceable
                scope.
              </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="mt-1 text-3xl font-extrabold text-[var(--hs-text)]">
                    Baby lounger release checklist
                  </h2>
                </div>
              </div>
              <p className="hs-muted mt-4 text-base leading-7">
                Connect qualified product evidence to sampled mass production and
                pack-out. The module does not turn an onsite comparison into prescribed
                performance testing, certification, legal advice, or a safety guarantee.
              </p>
                ...
                >
                  ...
                  {section.id === 'why-current' ? (
                    <p className="hs-muted mt-5 text-sm leading-6">
                      ...
                      <a
                        ...
                        target="_blank"
                      >
                        CPSC infant support cushion guidance
                      </a>
                      , and the{' '}
                      <a
                        className="hs-text-link"
                  ...
                  {section.id === 'product-route' ? (
                    <p className="hs-muted mt-5 text-sm leading-6">
                      ...
                      ; this guide does not replace the controlling rules, incorporated
                      standards, or qualified advice.
                    </p>
                  ) : null}
      ...
      <section className="hs-section-soft scroll-mt-24" id="decision-table">
        <div className="hs-container hs-section">
          <Reveal className="max-w-3xl">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Turn lounger evidence into a payment or pickup decision.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Record exact cleared models, materials, production dates, lots, cartons,
              evidence versions, samples, correction status, and open conditions. A
              pass should never hide missing classification, unsupported testing,
              changed production, or unresolved qualified decisions.
            </p>
          </Reveal>
      ...
      <EvidenceBasisSection
        ...
        intro="This guide combines current U.S. regulator records and independent professional coverage with the product-route, laboratory, construction, label, registration, packaging, correction, and release evidence a buyer can organize before baby loungers leave China."
      ...
      <section className="hs-section-white scroll-mt-24" id="public-case">
        <div className="hs-container hs-section max-w-4xl">
          <Reveal>
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Cpzzkq baby loungers: an affected scope that expanded.
            </h2>
            <div className="hs-muted mt-4 grid gap-4 text-base leading-7">
              <p>
                <strong className="text-[var(--hs-text)]">What happened:</strong> CPSC
                recalled about 2,100 Cpzzkq baby loungers on April 23, 2026. On July 30,
                it expanded the action to 195 additional green and purple units, for an
                identified total of about 2,195. CPSC states that the padding can
                obstruct an infant&apos;s breathing and that the products violate the
                mandatory infant support cushion standard.
              </p>
              <p>
                ...
                <a
                  ...
                  target="_blank"
                >
                  expanded CPSC recall
                </a>{' '}
                identifies model UMCDB01, colors, side-label identity, a China retailer
                and place of manufacture, Amazon sales from May through June 2026, and
                no reported incidents or injuries. The{' '}
                <a
                  className="hs-text-link"
                ...
                documents the earlier colors, sales period, and affected scope.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">Buyer lesson:</strong>{' '}
                Product identity cannot stop at one approved color, sample, label, or
                report. Map every model, color, material version, production date, lot,
                and carton to qualified evidence, then compare the finished shipment
                with that frozen scope before release.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">
                  Limits of comparison:
                </strong>{' '}
                The recall does not identify every technical cause or prove every
                lounger, seller, factory, material, or lot has the same problem. Huang
                Sourcing had no role in the case, and a pre-shipment inspection cannot
                reproduce prescribed performance testing or issue a compliance
                decision.
              </p>
            </div>
          </Reveal>
        ...
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-2">
          ...
          >
            ...
            <div className="mt-5 grid gap-4 text-sm leading-6 text-[var(--hs-muted)]">
              <p>
                Name the cleared destination, product route, model, materials, factory,
                production dates, lot, cartons, quantities, evidence version, test
            ...
            <div className="grid gap-7 lg:grid-cols-12 lg:items-center">
              <div className="lg:col-span-8">
                ...
                <h2 className="mt-4 text-3xl font-extrabold">
                  Turn open lounger evidence into a shipment decision.
                </h2>
                <p className="mt-3 max-w-3xl text-base leading-7 text-white/80">
                  Share the product route, model list, specifications, approved sample,
                  materials, reports, labels, registration files, packaging, carton
              ...
              <div className="flex flex-col gap-3 lg:col-span-4">
                <ContactAgentButton
                  analyticsLabel="Check baby loungers before shipment"
                  analyticsLocation="baby_lounger_checks_china_article_final_cta"
        ...
        <div className="hs-container hs-section">
          <Reveal>
            ...
            <p className="hs-muted mt-3 max-w-3xl text-sm leading-6">
              Public records and current guidance checked August 4, 2026 Beijing time.
