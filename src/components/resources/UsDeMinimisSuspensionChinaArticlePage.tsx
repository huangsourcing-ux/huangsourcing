...
import {
  makeUsDeMinimisSuspensionChinaArticleJsonLd,
  usDeMinimisSuspensionChinaArticle,
} from '@/lib/us-de-minimis-suspension-china-shipments-2026-article'
...
export function UsDeMinimisSuspensionChinaArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makeUsDeMinimisSuspensionChinaArticleJsonLd()} />
      <SiteBreadcrumbs
        ...
        <div className="hs-container grid gap-10 py-10 sm:py-14 lg:grid-cols-12 lg:py-16">
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="us_de_minimis_suspension_article_hero"
          ...
          <Reveal className="lg:col-span-6" delayMs={120}>
            ...
            <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {['Entry', 'Origin', 'Value', 'Labels'].map((item) => (
                <a
          ...
          <article className="min-w-0 lg:col-span-8">
            <Reveal>
              ...
              <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
                What should buyers check before U.S.-bound China parcels ship?
              </h2>
              <p className="hs-muted mt-4 text-base leading-7">
                Confirm the entry owner, importer data, product identity, origin,
                supportable value, labels, packing evidence, and regulated-product
                documents before the supplier, warehouse, or forwarder releases the
                shipment.
              </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="mt-1 text-3xl font-extrabold text-[var(--hs-text)]">
                    U.S. de minimis suspension checklist
                  </h2>
                </div>
              </div>
              <p className="hs-muted mt-4 text-base leading-7">
                The check connects the physical goods and China-side files to the
                entry owner instructions before the shipment leaves the supplier,
                warehouse, or forwarder.
              </p>
      ...
      <EvidenceDecisionMatrix
        id="decision-table"
        intro="Use this table to decide whether a low-value U.S.-bound shipment is ready for pickup, needs correction, needs broker input, or should be held before leaving China."
        rows={article.decisionRows}
        title="Turn shipment facts into a release decision."
      />

      <EvidenceBasisSection
        className="hs-section-white"
        intro="This guide starts with official CBP and Federal Register source context, then narrows the issue to the product, label, parcel, invoice, packing, and supplier evidence that can be checked while goods are still in China."
      ...
      <section className="hs-section-soft" id="source-notes">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Verify the rule, then check the shipment evidence.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              These sources explain the de minimis suspension, entry process changes,
              and low-value shipment enforcement context. They do not replace
              shipment-specific customs, broker, carrier, tax, product safety, or legal
              advice.
            </p>
          </Reveal>
        ...
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-5 text-3xl font-extrabold text-[var(--hs-text)]">
              What to send before the shipment evidence check.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Send product, customs, label, packing, and broker or carrier references
              so the China-side check can compare the actual goods against the file the
              U.S. side expects to use.
            </p>
          </Reveal>
      ...
      <section className="hs-section-soft" id="red-flags">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-5 text-3xl font-extrabold text-[var(--hs-text)]">
              U.S. low-value shipment red flags before dispatch.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Pause when origin, value, entry ownership, labels, product evidence, or
              regulated-product files cannot be tied to the real goods in China.
            </p>
          </Reveal>
          <Reveal className="lg:col-span-8">
      ...
      <section className="hs-section-white" id="scope-limits">
        <div className="hs-container hs-section max-w-4xl">
          <Reveal>
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              A China-side check is not U.S. customs entry approval.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              The report can show what was visible and provided before dispatch. It
              cannot decide tariff classification, valuation, origin legal treatment,
              entry type, admissibility, or duty liability.
            </p>
      ...
      <section className="hs-section-soft">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Build customs evidence into the shipment decision.
            </h2>
          </Reveal>
          <div className="grid gap-3 md:grid-cols-2 lg:col-span-8">
          ...
          <Reveal className="hs-cta-band px-6 py-10 text-white sm:px-10 lg:flex lg:items-center lg:justify-between lg:gap-10">
            <div className="relative">
              <div className="flex items-center gap-2 text-sm font-extrabold text-red-200">
                <Globe2 aria-hidden className="size-4" /> Before U.S.-bound goods
                leave China
              </div>
              <h2 className="mt-3 text-3xl font-extrabold">
                Check origin, value, labels, invoice data, and release evidence before
                dispatch.
              </h2>
              <p className="mt-3 max-w-2xl text-base leading-7 text-slate-300">
                Send the SKU list, invoice draft, packing list, parcel labels, broker
                instructions, regulated-product files, and pickup deadline before the
                supplier or forwarder releases the shipment.
              </p>
            </div>
            <ContactAgentButton
              analyticsLabel={article.primaryCta.label}
              analyticsLocation="us_de_minimis_suspension_article_final"
