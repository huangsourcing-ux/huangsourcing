...
export function EuGpsrLabelCheckChinaArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makeEuGpsrLabelCheckChinaArticleJsonLd()} />
      <SiteBreadcrumbs
        ...
        <div className="hs-container grid gap-10 py-10 sm:py-14 lg:grid-cols-12 lg:py-16">
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="eu_gpsr_label_check_article_hero"
          ...
          <Reveal className="lg:col-span-6" delayMs={120}>
            ...
            <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {['Identity', 'Operator', 'Warnings', 'Listing'].map((item) => (
                <a
          ...
          <article className="min-w-0 lg:col-span-8">
            <Reveal>
              ...
              <p className="hs-muted mt-4 text-base leading-7">
                Check that the approved GPSR label plan is visible on the actual
                product, packaging, instructions, and listing evidence before final
                payment or pickup. The practical release question is whether the goods
                in cartons match the buyer-approved product identity, manufacturer
                details, responsible-person details, warnings, language version, and
            ...
            <Reveal as="section" className="mt-12 scroll-mt-24" id="gpsr-checklist">
              ...
              <p className="hs-muted mt-4 text-base leading-7">
                The check connects buyer-approved compliance references to the physical
                order. A label file, responsible-person email, or marketplace screenshot
                matters only when the same information appears on the correct product,
                SKU, package, instruction set, and shipment record.
              </p>
      ...
      <section className="hs-section-soft" id="decision-table">
        <div className="hs-container hs-section">
          <Reveal className="max-w-3xl">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Turn GPSR evidence into a payment or pickup decision.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Use the table to separate visible China-side evidence from compliance
              decisions that still belong with the buyer and qualified EU specialists.
            </p>
          </Reveal>
      ...
      <EvidenceBasisSection
        ...
        intro="This guide is based on official EU GPSR and Safety Gate source context, then narrowed to the visible product, label, package, manual, listing, and carton evidence that can be checked before goods leave China."
      ...
      <section className="hs-section-soft" id="source-notes">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Verify the rule, then check the physical evidence.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              These sources explain the regulation, product-safety system, and current
              Safety Gate context. They do not replace product-specific EU advice.
            </p>
          </Reveal>
      ...
      <section className="hs-section-white" id="documents">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <p className="hs-muted mt-3 text-base leading-7">
              Send final references, not draft chat screenshots, so the onsite evidence
              can be judged against the version the buyer actually approved.
            </p>
          </Reveal>
      ...
      <section className="hs-section-soft" id="red-flags">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-5 text-3xl font-extrabold text-[var(--hs-text)]">
              GPSR label red flags before shipment.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Pause payment or pickup when the physical evidence cannot be connected
              to the approved product, operator, warning, language, and carton records.
            </p>
          </Reveal>
          <Reveal className="lg:col-span-8">
      ...
      <section className="hs-section-white" id="scope-limits">
        <div className="hs-container hs-section max-w-4xl">
          <Reveal>
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              A China-side check is not EU compliance approval.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              The report can show what was visible before shipment. It cannot decide
              whether the product is legally safe, properly certified, or accepted by an
              EU authority or marketplace.
            </p>
      ...
      <section className="hs-section-soft">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Build the label check into the payment decision.
            </h2>
          </Reveal>
          <div className="grid gap-3 md:grid-cols-2 lg:col-span-8">
          ...
          <Reveal className="hs-cta-band px-6 py-10 text-white sm:px-10 lg:flex lg:items-center lg:justify-between lg:gap-10">
            <div className="relative">
              <div className="flex items-center gap-2 text-sm font-extrabold text-red-200">
                <Globe2 aria-hidden className="size-4" /> Before EU-bound goods leave China
              </div>
              <h2 className="mt-3 text-3xl font-extrabold">
                Check labels, manuals, and packaging while correction is still practical.
              </h2>
              <p className="mt-3 max-w-2xl text-base leading-7 text-slate-300">
                Send the approved GPSR references, SKU list, carton records, label files,
                manual files, listing evidence, and deadline before the final release.
              </p>
            </div>
            <ContactAgentButton
              analyticsLabel={article.primaryCta.label}
              analyticsLocation="eu_gpsr_label_check_article_final"
