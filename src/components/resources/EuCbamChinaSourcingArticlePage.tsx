...
import {
  euCbamChinaSourcingArticle,
  makeEuCbamChinaSourcingArticleJsonLd,
} from '@/lib/eu-cbam-china-sourcing-2026-article'
...
export function EuCbamChinaSourcingArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makeEuCbamChinaSourcingArticleJsonLd()} />
      <SiteBreadcrumbs
        ...
        <div className="hs-container grid gap-10 py-10 sm:py-14 lg:grid-cols-12 lg:py-16">
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="eu_cbam_china_sourcing_article_hero"
          ...
          <Reveal className="lg:col-span-6" delayMs={120}>
            ...
            <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {['Scope', 'Mass', 'Data', 'Handoff'].map((item) => (
                <a
          ...
          <article className="min-w-0 lg:col-span-8">
            <Reveal>
              ...
              <p className="hs-muted mt-4 text-base leading-7">
                Check whether the exact product is in CBAM scope, whether the
                supplier can identify the actual production installation, whether
                emissions or default-value instructions are accepted by the EU-side
                owner, and whether invoice, packing, mass, origin, and registry
                handoff records match before cartons leave China.
              </p>
            ...
            <Reveal as="section" className="mt-12 scroll-mt-24" id="cbam-checklist">
              ...
              <p className="hs-muted mt-4 text-base leading-7">
                The check is practical: scope the product, identify the actual
                producer, collect installation and emissions-data references, and
                package shipment evidence for the responsible EU-side CBAM owner.
              </p>
      ...
      <EvidenceDecisionMatrix
        id="decision-table"
        intro="Use this table to decide whether CBAM evidence is ready enough for deposit, final payment, supplier correction, specialist review, or a hold before pickup."
        rows={article.decisionRows}
        title="Turn CBAM supplier data into a payment or shipment decision."
      />

      <EvidenceBasisSection
        className="hs-section-white"
        intro="This guide is based on official EU CBAM source context, then narrowed to product scope, supplier installation, emissions-data, registry, invoice, packing, and importer-handoff evidence that can be checked while goods are still in China."
        ...
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <p className="hs-muted mt-3 text-base leading-7">
              These sources explain CBAM scope, the definitive regime, registry,
              reporting, sector pages, default values, and verification. They do
              not replace shipment-specific EU compliance, customs, tax, or legal advice.
            </p>
          </Reveal>
      ...
      <section className="hs-section-white" id="documents">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <p className="hs-muted mt-3 text-base leading-7">
              Send product, supplier, invoice, mass, and EU responsibility notes so
              the report can compare physical evidence against the files the EU team
              expects to use.
            </p>
          </Reveal>
      ...
      <section className="hs-section-soft" id="red-flags">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <p className="hs-muted mt-3 text-base leading-7">
              Pause when product scope, producer identity, emissions data, mass,
              origin, or EU handoff cannot be tied to the actual shipment.
            </p>
          </Reveal>
          <Reveal className="lg:col-span-8">
        ...
        <div className="hs-container hs-section max-w-4xl">
          <Reveal>
            ...
            <p className="hs-muted mt-3 text-base leading-7">
              ...
              cannot decide whether a product is covered, whether emissions data is
              legally sufficient, or whether customs will accept the entry.
            </p>
          ...
          <Reveal className="hs-cta-band px-6 py-10 text-white sm:px-10 lg:flex lg:items-center lg:justify-between lg:gap-10">
            <div className="relative">
              <div className="flex items-center gap-2 text-sm font-extrabold text-red-200">
                <Globe2 aria-hidden className="size-4" /> Before EU-bound CBAM-risk goods leave China
              </div>
              <h2 className="mt-3 text-3xl font-extrabold">
                Check product, producer, invoice, mass, and supplier data before
                shipment release.
              </h2>
              <p className="mt-3 max-w-2xl text-base leading-7 text-slate-300">
                Send the product list, CN notes, invoice drafts, packing records,
                supplier installation details, emissions files, and release deadline
                before final shipment approval.
              </p>
            </div>
            <ContactAgentButton
              analyticsLabel={article.primaryCta.label}
              analyticsLocation="eu_cbam_china_sourcing_article_final"
