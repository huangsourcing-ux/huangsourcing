...
import {
  chinaFactorySubcontractingRiskArticle,
  makeChinaFactorySubcontractingRiskArticleJsonLd,
} from '@/lib/china-factory-subcontracting-risk-article'
...
export function ChinaFactorySubcontractingRiskArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makeChinaFactorySubcontractingRiskArticleJsonLd()} />
      <SiteBreadcrumbs
        ...
        <div className="hs-container grid gap-10 py-10 sm:py-14 lg:grid-cols-12 lg:py-16">
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="china_factory_subcontracting_risk_article_hero"
          ...
          <Reveal className="lg:col-span-6" delayMs={120}>
            ...
            <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {['Seller', 'Factory', 'Process', 'Pickup'].map((item) => (
                <a
          ...
          <article className="min-w-0 lg:col-span-8">
            <Reveal>
              ...
              <p className="hs-muted mt-4 text-base leading-7">
                Name the seller, production site, critical outside processes, change rules,
                inspection access, and pickup location before money or production moves. Then
                connect every update to the actual order and approved factory.
              </p>
      ...
      <section className="hs-section-soft" id="decision-table">
        <div className="hs-container hs-section">
          <Reveal className="max-w-3xl">
            <p className="hs-eyebrow">Production-site decision table</p>
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Connect factory evidence to the next buyer decision.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              The same outside process can be routine, conditional, or unacceptable depending on
              disclosure, capability, controls, records, access, and the product’s market rules.
            </p>
          </Reveal>
            ...
            <table className="w-full min-w-3xl border-collapse text-left text-sm leading-6">
              <thead className="bg-[var(--hs-navy)] text-white">
                <tr>
                  ...
                  <th className="border-l border-white/10 p-4 font-extrabold" scope="col">What was checked</th>
      ...
      <EvidenceBasisSection
        ...
        intro="This guide connects supplier identity, production-site evidence, process controls, order records, and inspection access to decisions importers can make before payment or shipment release."
      ...
      <section className="hs-section-soft" id="source-notes">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <p className="hs-eyebrow mt-5">Primary-source context</p>
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Standards and importer responsibilities vary by product and market.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              These official sources frame quality-system, traceability, product-safety, and
              supply-chain due-diligence questions. They do not replace product-specific advice.
            </p>
          </Reveal>
        ...
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-5 text-3xl font-extrabold text-[var(--hs-text)]">
              What to send for a factory-identity review.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Send the seller, site, product, production, payment, and pickup evidence together so
              the relationships can be checked rather than reviewed as isolated documents.
            </p>
          </Reveal>
      ...
      <section className="hs-section-soft" id="red-flags">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-5 text-3xl font-extrabold text-[var(--hs-text)]">
              Red flags that production may be elsewhere.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              No single signal proves undisclosed subcontracting. Several unexplained mismatches
              justify stronger evidence before the buyer relies on the claimed factory.
            </p>
          </Reveal>
      ...
      <section className="hs-section-white" id="limits">
        <div className="hs-container hs-section max-w-4xl">
          <Reveal>
            <div className="hs-icon-box size-12"><Building2 aria-hidden className="size-6" /></div>
            <p className="hs-eyebrow mt-5">Scope limits</p>
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              What factory verification cannot guarantee.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Verification improves visibility at a defined time and scope. It cannot guarantee
              future supplier conduct, product conformity, or destination-market compliance.
            </p>
      ...
      <section className="hs-section-soft">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Verify the site, reference, progress, and finished goods.
            </h2>
          </Reveal>
          <div className="grid gap-3 md:grid-cols-2 lg:col-span-8">
        ...
        <div className="hs-container hs-section">
          <Reveal className="hs-cta-band px-6 py-10 text-white sm:px-10 lg:flex lg:items-center lg:justify-between lg:gap-10">
            <div className="relative">
              <p className="text-sm font-extrabold text-red-200">Before payment or shipment release</p>
              <h2 className="mt-3 text-3xl font-extrabold">
                Verify the seller, actual factory, production evidence, and pickup location.
              </h2>
              <p className="mt-3 max-w-2xl text-base leading-7 text-slate-300">
                Send the supplier details, order files, claimed factory address, current evidence,
                payment stage, and deadline for a China-side review.
              </p>
            </div>
            <ContactAgentButton
              analyticsLabel={article.primaryCta.label}
              analyticsLocation="china_factory_subcontracting_risk_article_final"
