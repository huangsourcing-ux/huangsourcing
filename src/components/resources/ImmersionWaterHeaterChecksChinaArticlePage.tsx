...
import {
  immersionWaterHeaterChecksChinaArticle,
  makeImmersionWaterHeaterChecksChinaArticleJsonLd,
} from '@/lib/immersion-water-heater-checks-china-article'
...
export function ImmersionWaterHeaterChecksChinaArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makeImmersionWaterHeaterChecksChinaArticleJsonLd()} />
      <SiteBreadcrumbs
        ...
        <div className="hs-container grid gap-10 py-10 sm:py-14 lg:grid-cols-12 lg:py-16">
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="immersion_water_heater_checks_china_article_hero"
          ...
          <Reveal className="lg:col-span-6" delayMs={120}>
            ...
            <p className="hs-muted mt-3 text-xs leading-5">
              Neutral illustration of a generic, unplugged China-side product check;
              not evidence from the cited federal case.
            </p>
            <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {['Exact Model', 'Protection', 'Claims', 'Release'].map((item) => (
                <a
          ...
          <article className="min-w-0 lg:col-span-8">
            <Reveal>
              ...
              <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
                What should buyers check before immersion heaters leave China?
              </h2>
              <p className="hs-muted mt-4 text-base leading-7">
                Match the exact production model, ratings, protection design, cord,
                plug, labels, instructions, and claims to qualified evidence and an
                approved reference. Inspect sampled goods and cartons for identity and
                visible conformity. Hold every unresolved model or lot instead of using
                a visual pass or brief heating demonstration as a fire-safety decision.
              </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="mt-1 text-3xl font-extrabold text-[var(--hs-text)]">
                    Immersion water heater release checklist
                  </h2>
                </div>
              </div>
              <p className="hs-muted mt-4 text-base leading-7">
                ...
                into an electrical laboratory test, certification, importer filing, or
                ...
                >
                  ...
                  {section.id === 'dry-burn-evidence' ? (
                    <p className="hs-muted mt-5 text-sm leading-6">
                      ...
                      for the complete procedural context, allegations, test
                      descriptions, and stated limits.
                    </p>
                  ) : null}
                  {section.id === 'claims-labels' ? (
                    <p className="hs-muted mt-5 text-sm leading-6">
                      Check claimed UL records through the official{' '}
                      <a
                        className="hs-text-link"
                        ...
                        target="_blank"
                      >
                        UL Solutions Product iQ guidance
                      </a>
                      , then map the result to the exact production model and
                      construction.
                    </p>
                  ) : null}
      ...
      <section className="hs-section-soft" id="decision-table">
        <div className="hs-container hs-section">
          <Reveal className="max-w-3xl">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Turn heater evidence into a payment or pickup decision.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Record the exact cleared model and lot and every open condition. A pass
              should never conceal unverified protection, certification scope,
              inaccessible stock, mixed components, or required specialist decisions.
            </p>
          </Reveal>
      ...
      <EvidenceBasisSection
        ...
        intro="This guide combines current public CPSC and DOJ records, the filed complaint, independent reporting, and official certification-directory guidance with the exact-model, technical-file, physical-product, warning, packaging, correction, and release evidence a buyer can organize before goods leave China."
      ...
      <section className="hs-section-white scroll-mt-24" id="public-case">
        <div className="hs-container hs-section max-w-4xl">
          <Reveal>
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Lakkzoom complaint: an exact-model protection lesson.
            </h2>
            <div className="hs-muted mt-4 grid gap-4 text-base leading-7">
              <p>
                <strong className="text-[var(--hs-text)]">What happened:</strong> On
                July 22, 2026, the United States filed case 1:26-cv-02572 against a
                Chinese manufacturer and a Chinese retailer and importer. The complaint
                asks a federal court to declare certain Lakkzoom immersion water
                heaters imminently hazardous and order relief, including a mandatory
                recall. These are government allegations, not a final judgment.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">
                  What evidence was public:
                </strong>{' '}
                CPSC&apos;s warning identifies about 98,000 units, named models, and 235
                reports of fires. The complaint describes the product construction,
                alleged lack of adequate dry-burn protection, CPSC tests of 1500W and
                2000W samples under dry and partial-immersion conditions, UL 499
                context, marketing and certification claims, warnings, and requested
                relief.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">Buyer lesson:</strong> Freeze
                the exact model and protection design, verify every certification claim
                at the claimed source, obtain qualified abnormal-operation evidence,
                and inspect whether the production lot, labels, instructions, and
                cartons still match the approved configuration before release.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">
                ...
                . The record does not prove that every China-made heater or supplier has
                the same construction or risk, and a China-side inspection cannot
                reproduce the qualified fire-risk program.
              </p>
            </div>
          </Reveal>
        </div>
        ...
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-2">
          ...
          >
            ...
            <div className="mt-5 grid gap-4 text-sm leading-6 text-[var(--hs-muted)]">
              <p>
                Name the exact cleared model, factory, lot, cartons, quantities,
                evidence version, certification record, inspection sample, open
                conditions, correction status, and responsible release owner.
              </p>
              <p>
                If a failed or changed lot is corrected, require traceable segregation,
                qualified redesign or retest decisions, revised files, repeat inspection,
                and a new written release. Do not overwrite the original mismatch record.
              </p>
            </div>
          </Reveal>
        </div>
          ...
          <Reveal className="rounded-[var(--hs-radius)] bg-[var(--hs-navy)] p-7 text-white shadow-[var(--hs-shadow-lg)] sm:p-9">
            <div className="grid gap-7 lg:grid-cols-12 lg:items-center">
              <div className="lg:col-span-8">
                <div className="flex items-center gap-3">
                  <Flame aria-hidden className="size-7 text-[var(--hs-accent)]" />
                ...
                <p className="mt-3 max-w-3xl text-base leading-7 text-white/80">
                  Share the model list, specifications, protection evidence, report and
                  certification files, labels, instructions, packaging, carton map, and
              ...
              <div className="flex flex-col gap-3 lg:col-span-4">
                <ContactAgentButton
                  analyticsLabel="Check immersion water heaters before shipment"
                  analyticsLocation="immersion_water_heater_checks_china_article_final_cta"
        ...
        <div className="hs-container hs-section">
          <Reveal>
            ...
            <p className="hs-muted mt-3 max-w-3xl text-sm leading-6">
              Public records and current guidance checked July 29, 2026 Beijing time.
