...
import {
  makeSmokeCoAlarmChecksChinaArticleJsonLd,
  smokeCoAlarmChecksChinaArticle,
} from '@/lib/smoke-co-alarm-checks-china-article'
...
export function SmokeCoAlarmChecksChinaArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makeSmokeCoAlarmChecksChinaArticleJsonLd()} />
      <SiteBreadcrumbs
        ...
        <div className="hs-container grid gap-10 py-10 sm:py-14 lg:grid-cols-12 lg:py-16">
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="smoke_co_alarm_checks_china_article_hero"
          ...
          <Reveal className="lg:col-span-6" delayMs={120}>
            ...
            <p className="hs-muted mt-3 text-xs leading-5">
              Neutral AI-generated illustration of a generic buyer-side evidence review;
              not a laboratory test, product certification, factory photograph, or
              evidence from either cited public case.
            </p>
            <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {['Exact model', 'Test evidence', 'Lot check', 'Release'].map((item) => (
                <a
          ...
          <article className="min-w-0 lg:col-span-8">
            <Reveal>
              ...
              <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
                What should buyers check before alarm lots leave China?
              </h2>
              <p className="hs-muted mt-4 text-base leading-7">
                Match each finished model, hardware and firmware revision, production
                lot, label, package, and carton to current qualified evidence and a
                controlled manufacturing file. Inspect sampled goods only with approved,
                safe methods. Hold any mismatch, but do not treat a test button, audible
                beep, supplier video, or improvised smoke or gas demonstration as proof
                of prescribed detection performance.
              </p>
            ...
            <Reveal as="section" className="mt-12 scroll-mt-24" id="release-checklist">
              ...
              <p className="hs-muted mt-4 text-base leading-7">
                ...
                inspection into smoke or CO response testing, certification, legal
                advice, installation approval, or a life-safety guarantee.
              </p>
                ...
                {article.checkGroups.map((group) => (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <Cpu aria-hidden className="size-5 text-[var(--hs-accent)]" />
      ...
      <EvidenceDecisionMatrix
        id="decision-table"
        intro="Record the exact cleared model, hardware and firmware, lot, package, carton range, and every open condition. A sampled physical pass must not conceal missing performance evidence, changed sensors or electronics, mixed builds, failed units, unresolved labels, or an incomplete importer decision."
        rows={article.decisionRows}
        title="Turn alarm evidence into a payment or shipment decision."
      />
        ...
        <div className="hs-container hs-section">
          <Reveal className="max-w-3xl">
            ...
            <p className="hs-muted mt-3 text-base leading-7">
              ...
              factory assumptions or improvised performance demonstrations.
            </p>
          </Reveal>
      ...
      <section className="hs-section-white">
        <div className="hs-container hs-section">
          <Reveal className="max-w-3xl">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Build a complete alarm evidence chain.
            </h2>
          </Reveal>
            ...
            <div className="grid gap-7 lg:grid-cols-12 lg:items-center">
              <div className="lg:col-span-8">
                ...
                <h2 className="mt-4 text-3xl font-extrabold">
                  Turn open alarm evidence into a shipment decision.
                </h2>
                <p className="mt-3 max-w-3xl text-base leading-7 text-white/80">
                  Share the exact models, hardware and firmware, controlled bill of
                  materials, reports, listing or certification records, certificate data,
                  approved checks, labels, packages, carton map, change history, and
              ...
              <div className="flex flex-col gap-3 lg:col-span-4">
                <ContactAgentButton
                  analyticsLabel="Check alarm lots before shipment"
                  analyticsLocation="smoke_co_alarm_checks_china_article_final_cta"
