...
import {
  makeTabletopFirePitChecksChinaArticleJsonLd,
  tabletopFirePitChecksChinaArticle,
} from '@/lib/tabletop-fire-pit-checks-china-article'
...
export function TabletopFirePitChecksChinaArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makeTabletopFirePitChecksChinaArticleJsonLd()} />
      <SiteBreadcrumbs
        ...
        <div className="hs-container grid gap-10 py-10 sm:py-14 lg:grid-cols-12 lg:py-16">
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="tabletop_fire_pit_checks_china_article_hero"
          ...
          <Reveal className="lg:col-span-6" delayMs={120}>
            ...
            <p className="hs-muted mt-3 text-xs leading-5">
              Neutral AI-generated illustration of a generic, unlit inspection setup;
          ...
          <article className="min-w-0 lg:col-span-8">
            <Reveal>
              ...
              <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
                What should buyers check before tabletop fire pits leave China?
              </h2>
              <p className="hs-muted mt-4 text-base leading-7">
                Match every model, fuel-system version, factory, production date, lot,
                and carton to a qualified scope decision, complete exact-sample report,
                approved construction, fuel and refill instructions, warnings, pack-out,
                and shipment identity. Hold generic, changed, mixed, damaged,
                unsupported, or untraceable scope before payment and pickup.
              </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="mt-1 text-3xl font-extrabold text-[var(--hs-text)]">
                    Tabletop fire pit release checklist
                  </h2>
                </div>
              </div>
              <p className="hs-muted mt-4 text-base leading-7">
                Connect qualified product evidence to sampled mass production and
                pack-out. This module does not turn an onsite comparison into live-fire
                testing, ASTM certification, legal advice, or a safety guarantee.
              </p>
                ...
                >
                  ...
                  {section.id === 'product-scope' ? (
                    <p className="hs-muted mt-5 text-sm leading-6">
                      ...
                      <a
                        ...
                        target="_blank"
                      >
                        ASTM F3363-25 official scope page
                      </a>{' '}
                      with qualified product and destination support; the public scope
                      summary is not a substitute for the controlling standard or a
                  ...
                  {section.id === 'qualified-evidence' ? (
                    <p className="hs-muted mt-5 text-sm leading-6">
                      ...
                      and inspect the limitations in Health Canada&apos;s{' '}
                      <a
                        className="hs-text-link"
                        ...
                        target="_blank"
                      >
                        portable-firepot compliance project
                      </a>
                      .
                    </p>
                  ) : null}
      ...
      <section className="hs-section-soft scroll-mt-24" id="decision-table">
        <div className="hs-container hs-section">
          <Reveal className="max-w-3xl">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Turn fire pit evidence into a payment or pickup decision.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Record exact cleared models, fuel-system versions, dates, lots, cartons,
              evidence versions, samples, corrections, and open conditions. A pass
              should never hide unsupported testing, changed production, or unresolved
              qualified decisions.
            </p>
          </Reveal>
      ...
      <EvidenceBasisSection
        ...
        intro="This guide combines current U.S. regulator records, an official standards scope page, Canadian enforcement evidence, and independent reporting with the product, test, construction, warning, packaging, correction, and release evidence a buyer can organize before fire pits leave China."
      ...
      <section className="hs-section-white scroll-mt-24" id="public-case">
        <div className="hs-container hs-section max-w-4xl">
          <Reveal>
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Houswise tabletop fire pits: a current flame-jetting warning.
            </h2>
            <div className="hs-muted mt-4 grid gap-4 text-base leading-7">
              <p>
                <strong className="text-[var(--hs-text)]">What happened:</strong> On
                July 16, 2026, CPSC warned consumers to stop using at least 53,500
                Houswise Vesper, Altair, Quad, and Astra tabletop fire pits. CPSC said
                an open pool of alcohol or similar liquid fuel can create an uncontrolled
                pool fire and that refilling while a flame remains can cause flame
                jetting. The agency reported more than two dozen incidents and seven
              ...
              <p>
                ...
                identifies the models, China origin, online sales channels, incident and
                injury reports, affected quantity, and the manufacturer&apos;s lack of an
                agreed recall or remedy. It does not publish a factory inspection file,
                full design history, or a report covering every market.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">Buyer lesson:</strong>{' '}
                Resolve the exact fuel and reservoir design before production, require
                qualified evidence for the actual sample, and confirm that mass
                production, warnings, instructions, accessories, lots, and cartons still
                match before release. A supplier&apos;s listing claim or visual similarity
                to a tested product is not enough.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">
                  Why the older Colsen case still matters:
                </strong>{' '}
                CPSC&apos;s{' '}
                <a
                  className="hs-text-link"
                ...
                document the same broad flame-jetting mechanism in a different product
                history. The 2026 Houswise and Rozato warnings show that the buyer
                decision remains current rather than being limited to one old recall.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">
                  Limits of comparison:
                </strong>{' '}
                The Houswise warning does not prove every fire pit, seller, factory,
                reservoir, fuel, or lot has the same problem. Huang Sourcing had no role
                in any cited case, and a pre-shipment inspection cannot reproduce a
                prescribed laboratory program or certify safe performance.
              </p>
            </div>
          </Reveal>
        </div>
        ...
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-2">
          ...
          >
            ...
            <div className="mt-5 grid gap-4 text-sm leading-6 text-[var(--hs-muted)]">
              <p>
                Name the cleared destination, intended use, model, fuel system,
                construction, factory, production dates, lot, cartons, quantities,
                report version, test samples, inspection samples, corrections, open
                conditions, and responsible release owner.
              </p>
              <p>
            ...
            <div className="grid gap-7 lg:grid-cols-12 lg:items-center">
              <div className="lg:col-span-8">
                ...
                <h2 className="mt-4 text-3xl font-extrabold">
                  Turn open fire pit evidence into a shipment decision.
                </h2>
                <p className="mt-3 max-w-3xl text-base leading-7 text-white/80">
                  Share the intended use, model list, fuel system, approved sample,
                  drawings, reports, warnings, instructions, packaging, carton map, and
                  payment deadline. Huang Sourcing can scope a practical China-side
                  comparison before balance payment or pickup.
                </p>
              </div>
              <div className="flex flex-col gap-3 lg:col-span-4">
                <ContactAgentButton
                  analyticsLabel="Check tabletop fire pits before shipment"
                  analyticsLocation="tabletop_fire_pit_checks_china_article_final_cta"
        ...
        <div className="hs-container hs-section">
          <Reveal>
            ...
            <p className="hs-muted mt-3 max-w-3xl text-sm leading-6">
              Public records, official standards information, and independent coverage
              checked August 5, 2026 Beijing time. Links are descriptive so buyers can
