...
import {
  childrensSleepwearChecksChinaArticle,
  makeChildrensSleepwearChecksChinaArticleJsonLd,
} from '@/lib/childrens-sleepwear-checks-china-article'
...
export function ChildrensSleepwearChecksChinaArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makeChildrensSleepwearChecksChinaArticleJsonLd()} />
      <SiteBreadcrumbs
        ...
        <div className="hs-container grid gap-10 py-10 sm:py-14 lg:grid-cols-12 lg:py-16">
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="childrens_sleepwear_checks_china_article_hero"
          ...
          <Reveal className="lg:col-span-6" delayMs={120}>
            ...
            <p className="hs-muted mt-3 text-xs leading-5">
              Neutral AI-generated illustration of a generic inspection bench; not a
              product photograph, laboratory setup, or evidence from the cited public
              case.
            </p>
            <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {['Classify', 'Map evidence', 'Inspect', 'Release'].map((item) => (
                <a
          ...
          <article className="min-w-0 lg:col-span-8">
            <Reveal>
              ...
              <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
                What should buyers check before children&apos;s sleepwear leaves China?
              </h2>
              <p className="hs-muted mt-4 text-base leading-7">
                Match every SKU, size, color, print, trim, factory, and production lot
                to a documented classification, FPU/GPU evidence, qualified report,
                certificate data, approved measurements, permanent labels, hangtags,
                package claims, and carton identity. Hold generic, changed, mixed,
                mislabeled, out-of-tolerance, or untraceable scope.
              </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="mt-1 text-3xl font-extrabold text-[var(--hs-text)]">
                    Children&apos;s sleepwear release checklist
                  </h2>
                </div>
              </div>
              <p className="hs-muted mt-4 text-base leading-7">
                Connect qualified product and production-unit evidence to sampled mass
                production and pack-out. The module does not turn an onsite comparison
                into flammability testing, certification, legal advice, or a guarantee.
              </p>
              ...
              {article.sections.map((section, index) => (
                ...
                >
                  ...
                  {section.id === 'why-current' ? (
                    <p className="hs-muted mt-5 text-sm leading-6">
                      ...
                      <a
                        ...
                        target="_blank"
                      >
                        CPSC certificate and eFiling update
                      </a>
                      .
                    </p>
                  ) : null}
                  ...
                  {section.id === 'classification' ? (
                    <p className="hs-muted mt-5 text-sm leading-6">
                      Review the route with the current{' '}
                      <a
                        className="hs-text-link"
                        ...
                        target="_blank"
                      >
                        CPSC children&apos;s sleepwear guidance
                      </a>{' '}
                      and qualified compliance parties; this guide is not a substitute
                      for the regulations, incorporated standards, or legal advice.
                    </p>
                  ) : null}
      ...
      <section className="hs-section-soft scroll-mt-24" id="decision-table">
        <div className="hs-container hs-section">
          <Reveal className="max-w-3xl">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Turn sleepwear evidence into a payment or pickup decision.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Record exact cleared SKUs, sizes, colors, prints, lots, cartons, evidence
              versions, samples, correction status, and open conditions. A pass should
              never hide missing classification, unsupported testing, changed
              production, or unresolved qualified decisions.
            </p>
          </Reveal>
      ...
      <EvidenceBasisSection
        ...
        intro="This guide combines current U.S. and Canadian regulator records with the classification, production-unit, laboratory, measurement, label, packaging, correction, and release evidence a buyer can organize before children's sleepwear leaves China."
      ...
      <section className="hs-section-white scroll-mt-24" id="public-case">
        <div className="hs-container hs-section max-w-4xl">
          <Reveal>
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Michley pajamas: one product, two current public actions.
            </h2>
            <div className="hs-muted mt-4 grid gap-4 text-base leading-7">
              <p>
                <strong className="text-[var(--hs-text)]">What happened:</strong> On
                June 18, 2026, CPSC warned consumers to stop using Michley pajamas sold
                online. On July 21, Health Canada published a recall for Michley
                children&apos;s pajamas sold in Canada. Both public records identify a
                children&apos;s sleepwear flammability problem and China origin.
              </p>
              <p>
                ...
                names the China seller and manufacture, describes one-piece pajamas,
                states about 40 units, and reports no incidents or injuries. The{' '}
                <a
                  className="hs-text-link"
                  href="https://recalls-rappels.canada.ca/en/alert-recall/michley-brand-children-s-pajamas-recalled-due-flammability-hazard"
                  rel="noreferrer"
                ...
                states 66 units were sold in Canada and reports no Canadian incidents
                or injuries as of July 16.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">Buyer lesson:</strong>{' '}
                Marketing name, appearance, and a sewn-in size label are not a complete
                release record. Resolve the product route, map qualified test and
                certificate evidence to the exact production scope, then compare the
                shipment&apos;s measurements, construction, labels, and lot identity.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">
                  Limits of comparison:
                </strong>{' '}
                The notices do not identify every technical cause or prove every pajama,
                factory, seller, fabric, or lot has the same problem. Huang Sourcing had
                no role in either action, and a pre-shipment inspection cannot reproduce
                laboratory flammability testing or issue a compliance decision.
              </p>
            </div>
          </Reveal>
        </div>
        ...
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-2">
          ...
          >
            ...
            <div className="mt-5 grid gap-4 text-sm leading-6 text-[var(--hs-muted)]">
              <p>
                Name the cleared destination, product route, SKU, sizes, colors,
                prints, trims, factory, FPU/GPU scope, lot, cartons, quantities,
                evidence version, report samples, inspection samples, corrections,
                open conditions, and responsible release owner.
              </p>
              <p>
                If a failed or changed lot is corrected, retain the original mismatch
                and require traceable segregation, qualified retest or certificate
      ...
      <section className="hs-section-soft scroll-mt-24" id="scope-limits">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <p className="hs-muted mt-3 text-base leading-7">
              Separate visible China-side checks from technical, laboratory,
              certification, regulatory, importer, marketplace, customs, and legal
              responsibilities.
            </p>
          </Reveal>
            ...
            <div className="grid gap-7 lg:grid-cols-12 lg:items-center">
              <div className="lg:col-span-8">
                ...
                <h2 className="mt-4 text-3xl font-extrabold">
                  Turn open sleepwear evidence into a shipment decision.
                </h2>
                <p className="mt-3 max-w-3xl text-base leading-7 text-white/80">
                  Share the product route, SKU and size list, tech pack, measurements,
                  fabrics, trims, FPU/GPU map, reports, labels, packaging, carton map,
              ...
              <div className="flex flex-col gap-3 lg:col-span-4">
                <ContactAgentButton
                  analyticsLabel="Check children's sleepwear before shipment"
                  analyticsLocation="childrens_sleepwear_checks_china_article_final_cta"
        ...
        <div className="hs-container hs-section">
          <Reveal>
            ...
            <p className="hs-muted mt-3 max-w-3xl text-sm leading-6">
              Public records and current guidance checked August 3, 2026 Beijing time.
