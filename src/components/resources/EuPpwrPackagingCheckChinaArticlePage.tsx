...
import {
  euPpwrPackagingCheckChinaArticle,
  makeEuPpwrPackagingCheckChinaArticleJsonLd,
} from '@/lib/eu-ppwr-packaging-check-china-sourcing-2026-article'
...
export function EuPpwrPackagingCheckChinaArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makeEuPpwrPackagingCheckChinaArticleJsonLd()} />
      <SiteBreadcrumbs
        ...
        <div className="hs-container grid gap-10 py-10 sm:py-14 lg:grid-cols-12 lg:py-16">
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="eu_ppwr_packaging_check_article_hero"
          ...
          <Reveal className="lg:col-span-6" delayMs={120}>
            ...
            <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {['Materials', 'Labels', 'PFAS', 'Files'].map((item) => (
                <a
      ...
      <section className="hs-section-white" id="quick-answer">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          ...
          <article className="min-w-0 lg:col-span-8">
            ...
            <Reveal as="section" className="mt-12 scroll-mt-24" id="ppwr-checklist">
              ...
              <p className="hs-muted mt-4 text-base leading-7">
                The check is practical: identify the packaging layers, connect them to
                the actual SKU and carton records, then compare visible packaging and
      ...
      <EvidenceDecisionMatrix
        id="decision-table"
        intro="Use this table to decide whether packaging evidence is ready enough for final payment, supplier correction, specialist review, or a hold before pickup."
        rows={article.decisionRows}
        title="Turn PPWR packaging evidence into a release decision."
      />

      <EvidenceBasisSection
        className="hs-section-white"
        intro="This guide is based on official EU PPWR source context, then narrowed to the packaging, label, carton, supplier-document, and importer-handoff evidence that can be checked while goods are still in China."
        ...
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-5 text-3xl font-extrabold text-[var(--hs-text)]">
              What to send before the China-side packaging check.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Send final packaging references and responsibility notes so the report can
      ...
      <section className="hs-section-soft" id="red-flags">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-5 text-3xl font-extrabold text-[var(--hs-text)]">
              PPWR packaging red flags before shipment.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Pause payment or pickup when packaging files, labels, materials, and
              physical cartons cannot be tied to the same approved order.
            </p>
          </Reveal>
          <Reveal className="lg:col-span-8">
      ...
      <section className="hs-section-white" id="scope-limits">
        <div className="hs-container hs-section max-w-4xl">
          <Reveal>
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              A China-side check is not PPWR conformity approval.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              The report can show what was visible and provided before shipment. It
              cannot decide whether the packaging is legally compliant, properly
              declared, recyclable, registered, or accepted by an EU marketplace.
            </p>
      ...
      <section className="hs-section-soft">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Connect packaging evidence to the shipment decision.
            </h2>
          </Reveal>
          <div className="grid gap-3 md:grid-cols-2 lg:col-span-8">
          ...
          <Reveal className="hs-cta-band px-6 py-10 text-white sm:px-10 lg:flex lg:items-center lg:justify-between lg:gap-10">
            <div className="relative">
              ...
              <h2 className="mt-3 text-3xl font-extrabold">
                Check packaging, labels, and supplier files while correction is still
                practical.
              </h2>
              <p className="mt-3 max-w-2xl text-base leading-7 text-slate-300">
                Send the packaging artwork, material files, declarations, carton
                records, and release deadline before final shipment approval.
              </p>
            </div>
            <ContactAgentButton
              analyticsLabel={article.primaryCta.label}
              analyticsLocation="eu_ppwr_packaging_check_article_final"
