...
import {
  makeUflpaChinaSupplierCheckArticleJsonLd,
  uflpaChinaSupplierCheckArticle,
} from '@/lib/uflpa-china-supplier-check-2026-article'
...
export function UflpaChinaSupplierCheckArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makeUflpaChinaSupplierCheckArticleJsonLd()} />
      <SiteBreadcrumbs
        ...
        <div className="hs-container grid gap-10 py-10 sm:py-14 lg:grid-cols-12 lg:py-16">
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="uflpa_supplier_check_article_hero"
          ...
          <Reveal className="lg:col-span-6" delayMs={120}>
            ...
            <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {['Names', 'Factory', 'Materials', 'Handoff'].map((item) => (
                <a
          ...
          <article className="min-w-0 lg:col-span-8">
            <Reveal>
              ...
              <p className="hs-muted mt-4 text-base leading-7">
                Check whether supplier identity, production site, materials,
                upstream names, Entity List screening, order documents, and importer
                handoff can be tied to the exact goods before cartons leave China.
              </p>
            ...
            <Reveal as="section" className="mt-12 scroll-mt-24" id="uflpa-checklist">
              ...
              <p className="hs-muted mt-4 text-base leading-7">
                The check is practical: identify the supplier chain behind the order,
                collect evidence while goods are still in China, then separate visible
                facts from legal and customs conclusions.
              </p>
      ...
      <EvidenceDecisionMatrix
        id="decision-table"
        intro="Use this table to decide whether supplier-chain evidence is ready enough for deposit, final payment, specialist review, or a hold before pickup."
        rows={article.decisionRows}
        title="Turn UFLPA evidence gaps into a shipment release decision."
      />

      <EvidenceBasisSection
        className="hs-section-white"
        intro="This guide is based on official CBP and DHS forced-labor source context, then narrowed to supplier identity, production-site, material-origin, and importer-handoff evidence that can be checked before goods leave China."
      ...
      <section className="hs-section-soft" id="source-notes">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Verify the rule, then document the supplier chain.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              These sources explain CBP forced-labor enforcement, UFLPA, Entity List
              screening, high-priority sectors, and importer due diligence. They do
              not replace product-specific customs, broker, compliance, or legal advice.
            </p>
          </Reveal>
        ...
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-5 text-3xl font-extrabold text-[var(--hs-text)]">
              What to send before the supplier-chain check.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Send names, order files, material notes, and importer instructions so
              the report can compare China-side facts against the evidence the U.S.
              team expects to use.
            </p>
          </Reveal>
      ...
      <section className="hs-section-soft" id="red-flags">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-5 text-3xl font-extrabold text-[var(--hs-text)]">
              Supplier-chain red flags before shipment.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Pause payment or pickup when names, production site, materials, and
              importer responsibility cannot be tied to the same order.
            </p>
          </Reveal>
          <Reveal className="lg:col-span-8">
      ...
      <section className="hs-section-white" id="scope-limits">
        <div className="hs-container hs-section max-w-4xl">
          <Reveal>
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              A China-side check is not a UFLPA compliance decision.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              The report can show what was visible, provided, and inconsistent before
              shipment. It cannot decide whether goods are admissible, whether a
              supply chain is free of forced labor, or whether an importer can answer CBP.
            </p>
      ...
      <section className="hs-section-soft">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Connect supplier evidence to payment and shipment control.
            </h2>
          </Reveal>
          <div className="grid gap-3 md:grid-cols-2 lg:col-span-8">
          ...
          <Reveal className="hs-cta-band px-6 py-10 text-white sm:px-10 lg:flex lg:items-center lg:justify-between lg:gap-10">
            <div className="relative">
              ...
              <h2 className="mt-3 text-3xl font-extrabold">
                Check supplier identity, factory role, materials, and importer handoff while correction is still practical.
              </h2>
              <p className="mt-3 max-w-2xl text-base leading-7 text-slate-300">
                Send the supplier names, order files, material notes, carton records,
                importer instructions, and release deadline before final shipment approval.
              </p>
            </div>
            <ContactAgentButton
              analyticsLabel={article.primaryCta.label}
              analyticsLocation="uflpa_supplier_check_article_final"
