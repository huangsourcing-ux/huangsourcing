...
import {
  chinaSection301TariffCheckArticle,
  makeChinaSection301TariffCheckArticleJsonLd,
} from '@/lib/china-section-301-tariff-check-2026-article'
...
export function ChinaSection301TariffCheckArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makeChinaSection301TariffCheckArticleJsonLd()} />
      <SiteBreadcrumbs
        ...
        <div className="hs-container grid gap-10 py-10 sm:py-14 lg:grid-cols-12 lg:py-16">
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="section_301_tariff_check_article_hero"
          ...
          <Reveal className="lg:col-span-6" delayMs={120}>
            ...
            <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {['HTS', 'Origin', 'Quote', 'Release'].map((item) => (
                <a
          ...
          <article className="min-w-0 lg:col-span-8">
            <Reveal>
              ...
              <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
                What should buyers check before a China order locks in?
              </h2>
              <p className="hs-muted mt-4 text-base leading-7">
                Check whether product identity, supplier paperwork, country-of-origin
                facts, invoice wording, packing evidence, and importer or broker
                instructions line up before deposit, final payment, or forwarder pickup.
              </p>
            ...
            <Reveal as="section" className="mt-12 scroll-mt-24" id="section-301-checklist">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="mt-1 text-3xl font-extrabold text-[var(--hs-text)]">
                    Section 301 tariff evidence checklist
                  </h2>
                </div>
              </div>
              <p className="hs-muted mt-4 text-base leading-7">
                The check is practical: organize product, origin, quote, invoice,
                carton, and broker handoff evidence while supplier correction is
                still possible in China.
              </p>
      ...
      <EvidenceDecisionMatrix
        id="decision-table"
        intro="Use this table to decide whether tariff evidence is ready enough for deposit, final payment, specialist review, or a hold before pickup."
        rows={article.decisionRows}
        title="Turn Section 301 evidence gaps into a payment or shipment decision."
      />

      <EvidenceBasisSection
        className="hs-section-white"
        intro="This guide is based on official USTR and CBP trade-remedy source context, then narrowed to product identity, origin, supplier-paperwork, and importer-handoff evidence that can be checked before goods leave China."
      ...
      <section className="hs-section-soft" id="source-notes">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Verify the tariff rule, then document the product file.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              These sources explain Section 301 tariff actions, exclusion extensions,
              CBP trade-remedy administration, and related tariff context. They do
              not replace shipment-specific broker, customs, or legal advice.
            </p>
          </Reveal>
        ...
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-5 text-3xl font-extrabold text-[var(--hs-text)]">
              What to send before the tariff evidence check.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Send product details, supplier files, broker instructions, and draft
              shipment paperwork so the evidence can be compared before release.
            </p>
          </Reveal>
      ...
      <section className="hs-section-soft" id="red-flags">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-5 text-3xl font-extrabold text-[var(--hs-text)]">
              Tariff evidence red flags before payment.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Pause deposit, final payment, or pickup when product facts, origin,
              invoice wording, and specialist responsibility do not line up.
            </p>
          </Reveal>
          <Reveal className="lg:col-span-8">
      ...
      <section className="hs-section-white" id="scope-limits">
        <div className="hs-container hs-section max-w-4xl">
          <Reveal>
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              A China-side check is not a customs classification decision.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              The report can show what was visible, provided, corrected, and
              inconsistent before shipment. It cannot decide the HTS code, duty
              rate, exclusion eligibility, entry treatment, or legal sufficiency.
            </p>
      ...
      <section className="hs-section-soft">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Connect tariff evidence to supplier and shipment control.
            </h2>
          </Reveal>
          <div className="grid gap-3 md:grid-cols-2 lg:col-span-8">
          ...
          <Reveal className="hs-cta-band px-6 py-10 text-white sm:px-10 lg:flex lg:items-center lg:justify-between lg:gap-10">
            <div className="relative">
              <div className="flex items-center gap-2 text-sm font-extrabold text-red-200">
                <Globe2 aria-hidden className="size-4" /> Before tariff assumptions lock in
              </div>
              <h2 className="mt-3 text-3xl font-extrabold">
                Check product identity, origin, supplier paperwork, and broker handoff while correction is still practical.
              </h2>
              <p className="mt-3 max-w-2xl text-base leading-7 text-slate-300">
                Send the supplier names, product files, quote, invoice draft,
                packing records, broker instructions, and release deadline before
                final shipment approval.
              </p>
            </div>
            <ContactAgentButton
              analyticsLabel={article.primaryCta.label}
              analyticsLocation="section_301_tariff_check_article_final"
