...
import {
  buttonBatteryPackagingChinaArticle,
  makeButtonBatteryPackagingChinaArticleJsonLd,
} from '@/lib/button-battery-packaging-china-article'
...
export function ButtonBatteryPackagingChinaArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makeButtonBatteryPackagingChinaArticleJsonLd()} />
      <SiteBreadcrumbs
          ...
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="button_battery_packaging_china_article_hero"
      ...
      <EvidenceBasisSection
        ...
        intro="This guide is based on official CPSC records and current business guidance, then narrowed to visible packaging, warning, product, carton, supplier, and document evidence that can be checked before goods leave China."
      ...
      <section className="hs-section-soft">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Build packaging evidence into the shipment decision.
            </h2>
          </Reveal>
          <div className="grid gap-3 md:grid-cols-2 lg:col-span-8">
          ...
          <Reveal className="hs-cta-band px-6 py-10 text-white sm:px-10 lg:flex lg:items-center lg:justify-between lg:gap-10">
            <div className="relative">
              <div className="flex items-center gap-2 text-sm font-extrabold text-red-200">
                <Globe2 aria-hidden className="size-4" /> Before battery products leave China
              </div>
              <h2 className="mt-3 text-3xl font-extrabold">
                Check packaging, warnings, and product evidence while correction is
                still practical.
              </h2>
