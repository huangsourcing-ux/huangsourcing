...
import {
  cpscHabaRattleRecall,
  makeRattleTeetherChecksChinaArticleJsonLd,
  rattleTeetherChecksChinaArticle,
} from '@/lib/rattle-teether-checks-china-article'
...
export function RattleTeetherChecksChinaArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makeRattleTeetherChecksChinaArticleJsonLd()} />
      <SiteBreadcrumbs
        ...
        <div className="hs-container grid gap-10 py-10 sm:py-14 lg:grid-cols-12 lg:py-16">
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="rattle_teether_checks_china_article_hero"
          ...
          <Reveal className="lg:col-span-6" delayMs={120}>
            ...
            <p className="hs-muted mt-3 text-xs leading-5">
              Neutral AI-generated illustration of a generic rattle and teether review;
              not a factory photograph, test result, certification, or evidence from
              the cited public case.
            </p>
            <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {['Identity', 'Connection', 'Production lot', 'Release'].map((item) => (
                <a
          ...
          <article className="min-w-0 lg:col-span-8">
            <Reveal>
              ...
              <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
                What should buyers check before a rattle or teether lot leaves China?
              </h2>
              <p className="hs-muted mt-4 text-base leading-7">
                Match the exact product category, intended age, materials, components,
                connection design, approved references, qualified evidence, production
                version, labels, retail packs, lots, and cartons. Keep saleable-goods
                inspection separate from destructive use-and-abuse work. Hold any
                mismatch instead of treating a clean appearance or informal hand pull
                as proof that every component will remain retained.
              </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="mt-1 text-3xl font-extrabold text-[var(--hs-text)]">
                    Rattle and teether lot release checklist
                  </h2>
                </div>
              </div>
              <p className="hs-muted mt-4 text-base leading-7">
      ...
      <EvidenceDecisionMatrix
        id="decision-table"
        intro="Record exact models, intended age, construction revisions, test scope, production dates, lots, sacrificed samples, retail packs, destination labels, carton ranges, and every open condition. A passing visual sample must not conceal missing evidence, an unreviewed substitution, a destructive-test failure, or mixed stock."
        rows={article.decisionRows}
        title="Turn rattle and teether evidence into a payment or shipment decision."
      />

      <EvidenceBasisSection
        className="hs-section-white"
        intro="This guide combines a new August 2026 CPSC recall, the company record, current official toy and testing guidance, live retailer attention, and buyer-side sourcing analysis. It keeps case facts, product classification, qualified testing, routine inspection, certification, and release authority in separate scopes."
      ...
      <section className="hs-section-soft scroll-mt-24" id="public-case">
        <div className="hs-container hs-section max-w-4xl">
          <Reveal>
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              HABA recall: an exact batch and a glued-knot failure converged.
            </h2>
            <div className="hs-muted mt-4 grid gap-4 text-base leading-7">
              <p>
                <strong className="text-[var(--hs-text)]">What happened:</strong> On
                August 27, 2026, CPSC announced a recall of about 2,000 China-made HABA
                Rainbow Rattle Grasping and Teething Toys. The agency said a glued knot
                on the elastic cord could come untied and expose small wooden and
                plastic pieces. The notice reports two knot failures and no injuries.
              </p>
              <p>
                ...
                <a
                  ...
                  target="_blank"
                >
                  official CPSC recall 26-719
                </a>{' '}
                identifies item number 2012261001, batch code 0925, the connection
                failure, affected quantity, reports, sale period and channels,
                importer, China origin, and remedy. It does not publish the full
                drawings, bill of materials, test plan, raw use-and-abuse data,
                production-change history, root-cause analysis, or lot-release records.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">Buyer lesson:</strong>{' '}
                Control the component path and connection method first, then map
                qualified evidence and change records to the exact model and production
                lot. Inspect saleable goods for identity and visible assembly, but keep
                destructive retention and use-and-abuse work in a qualified, traceable
                test scope.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">
                ...
                The recall does not prove every rattle, teether, elastic construction,
                ...
                cannot certify compliance, reproduce full product life, eliminate
                choking risk, or guarantee every unit.
              </p>
            </div>
          </Reveal>
        </div>
        ...
        <div className="hs-container hs-section">
          <Reveal className="max-w-3xl">
            ...
            <p className="hs-muted mt-4 text-base leading-7">
              ...
              age, model, connection method, sample destruction, factory access, lot
              linkage, and traceability before the inspector reaches finished goods.
            </p>
          </Reveal>
            ...
            <div className="grid items-center gap-8 lg:grid-cols-12">
              <div className="lg:col-span-8">
                ...
                <h2 className="mt-4 text-3xl font-extrabold">
                  Turn rattle and teether evidence into a traceable release decision.
                </h2>
                <p className="mt-4 max-w-3xl text-base leading-7 text-white/75">
                  Send the exact models, intended age, connection revisions, reports,
                  approved references, production lots, destructive-test scope, retail
                  packs, carton map, known changes, and deadline. Huang Sourcing can
                  scope a practical China-side comparison before money or goods move.
                </p>
              </div>
              <div className="flex flex-col gap-3 lg:col-span-4">
                <ContactAgentButton
                  analyticsLabel="Check rattles before shipment"
                  analyticsLocation="rattle_teether_checks_china_article_final_cta"
        ...
        <div className="hs-container hs-section">
          <Reveal>
            ...
            <p className="hs-muted mt-3 max-w-3xl text-sm leading-6">
              Public regulator, company, and retailer records checked September 2,
              2026 Beijing time. Links identify the exact case, guidance, evidence
              basis, and limits used here.
            </p>
