...
import {
  makeMiniFridgeChecksChinaArticleJsonLd,
  miniFridgeChecksChinaArticle,
} from '@/lib/mini-fridge-checks-china-article'
...
export function MiniFridgeChecksChinaArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makeMiniFridgeChecksChinaArticleJsonLd()} />
      <SiteBreadcrumbs
        ...
        <div className="hs-container grid gap-10 py-10 sm:py-14 lg:grid-cols-12 lg:py-16">
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="mini_fridge_checks_china_article_hero"
          ...
          <Reveal className="lg:col-span-6" delayMs={120}>
            ...
            <p className="hs-muted mt-3 text-xs leading-5">
              Neutral AI-generated illustration of a generic buyer-side inspection
              setup; not a factory photograph, laboratory test, recalled product, or
              evidence from either cited public case.
            </p>
            <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {['Exact model', 'Power design', 'Batch check', 'Release'].map((item) => (
                <a
          ...
          <article className="min-w-0 lg:col-span-8">
            <Reveal>
              ...
              <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
                What should buyers check before mini fridge lots leave China?
              </h2>
              <p className="hs-muted mt-4 text-base leading-7">
                Match each finished model, input design, switch, cord, adapter,
                controlled electrical and cooling parts, production batch, label,
                package, and carton to approved evidence. Inspect sampled goods only
                with safe, defined methods. Hold any mismatch, but do not treat a short
                cooling run or supplier video as proof of electrical safety, abnormal
                operation, fire containment, or stable long-term temperature.
              </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="mt-1 text-3xl font-extrabold text-[var(--hs-text)]">
                    Mini fridge lot release checklist
                  </h2>
                </div>
              </div>
              <p className="hs-muted mt-4 text-base leading-7">
                Connect qualified model evidence and controlled production to sampled
                physical goods and pack-out. This checklist does not turn a routine
                inspection into electrical-safety testing, fire testing, certification,
                or a guarantee of safe temperature-controlled storage.
              </p>
      ...
      <EvidenceDecisionMatrix
        id="decision-table"
        intro="Record the exact cleared model, power design, cooling system, batch, package, carton range, and every open condition. A sampled functional pass must not conceal missing safety evidence, changed switches or electrical parts, mixed builds, failed units, unresolved labels, or an incomplete importer decision."
        rows={article.decisionRows}
        title="Turn mini fridge evidence into a payment or shipment decision."
      />

      <EvidenceBasisSection
        className="hs-section-white"
        intro="This guide combines the August 2026 Cooluli CPSC recall, the separate January 2026 Frigidaire-brand minifridge recall expansion, independent AP coverage, and buyer-side sourcing analysis. It keeps qualified testing, importer duties, production controls, inspection observations, and release decisions in separate scopes."
      ...
      <section className="hs-section-soft scroll-mt-24" id="public-case">
        <div className="hs-container hs-section max-w-4xl">
          <Reveal>
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Cooluli: the power architecture and batch both mattered.
            </h2>
            <div className="hs-muted mt-4 grid gap-4 text-base leading-7">
              <p>
                <strong className="text-[var(--hs-text)]">What happened:</strong> On
                August 13, 2026, CPSC recalled about 250,000 Cooluli 10-Liter and
                15-Liter minifridges because the electrical switch can short circuit,
                posing fire and burn hazards. The agency reported at least 19 events
                involving smoking, sparking, burning, melting, overheating, or fire,
                property damage exceeding $80,000, and one smoke-inhalation injury.
              </p>
              <p>
                ...
                <a
                  className="hs-text-link"
                  href="https://www.cpsc.gov/Recalls/2026/Cooluli-Recalls-10-Liter-and-15-Liter-Minifridges-Due-to-Fire-and-Burn-Hazards"
                  rel="noreferrer"
                  target="_blank"
                >
                  official CPSC recall
                </a>{' '}
                identifies the China manufacturer, affected series, model and batch
                label location, sales period, and an internal-power-supply design with
                separate AC and DC inputs. The remedy uses a replacement DC cord and a
                permanent sticker covering the AC input after the original cord is cut.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">Buyer lesson:</strong>{' '}
                Freeze the actual power tree, input ports, switch, cord, adapter,
                controlled parts, model, batch, and cartons before release. Similar
                outside appearance or a successful short cooling demo does not show
                that the shipment has the approved internal build or qualified evidence.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">
                ...
                <a
                  className="hs-text-link"
                  href="https://www.cpsc.gov/Recall-Products/Refrigerators"
                  rel="noreferrer"
                  target="_blank"
                >
                  refrigerator recall records
                </a>{' '}
                include a January 15, 2026 expansion for about 330,000 China-made
                Frigidaire-brand minifridges after fire reports, following 634,000 units
                recalled in 2024. The cases are separate, but together they support a
                current recurring need to control electrical configuration and lot
                identity before shipment.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">
                  Limits of comparison:
                </strong>{' '}
                These records do not prove every mini fridge, seller, supplier, factory,
                model, or batch has the same failure. Huang Sourcing had no role in
                either case. A sampled buyer-side inspection cannot reproduce prescribed
                electrical or fire testing, certify a model, or guarantee future field
                performance or temperature-controlled storage.
              </p>
            </div>
          </Reveal>
        </div>
        ...
        <div className="hs-container hs-section">
          <Reveal className="max-w-3xl">
            ...
            <p className="hs-muted mt-3 text-base leading-7">
              ...
              factory assumptions or improvised electrical tests.
            </p>
          </Reveal>
      ...
      <section className="hs-section-white">
        <div className="hs-container hs-section">
          <Reveal className="max-w-3xl">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Build a complete mini fridge evidence chain.
            </h2>
          </Reveal>
            ...
            <div className="grid gap-7 lg:grid-cols-12 lg:items-center">
              <div className="lg:col-span-8">
                ...
                <h2 className="mt-4 text-3xl font-extrabold">
                  Turn open mini fridge evidence into a shipment decision.
                </h2>
                <p className="mt-3 max-w-3xl text-base leading-7 text-white/80">
                  Share the exact models, power designs, controlled bill of materials,
                  reports, approved checks, ratings, instructions, packages, batch and
                  carton map, change history, and deadline. Huang Sourcing can scope a
                  practical China-side comparison before balance payment or pickup.
                </p>
              </div>
              <div className="flex flex-col gap-3 lg:col-span-4">
                <ContactAgentButton
                  analyticsLabel="Check mini fridges before shipment"
                  analyticsLocation="mini_fridge_checks_china_article_final_cta"
        ...
        <div className="hs-container hs-section">
          <Reveal>
            ...
            <p className="hs-muted mt-3 max-w-3xl text-sm leading-6">
              Public records and current independent reporting checked August 15, 2026
              Beijing time. Links identify the exact products, architecture, batches,
              incidents, damage, injury, dates, actions, and interpretation limits used
              in this guide.
            </p>
