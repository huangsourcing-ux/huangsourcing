...
import {
  euTextileDigitalProductPassportChinaArticle,
  makeEuTextileDigitalProductPassportChinaArticleJsonLd,
} from '@/lib/eu-textile-digital-product-passport-china-sourcing-2026-article'
...
export function EuTextileDigitalProductPassportChinaArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makeEuTextileDigitalProductPassportChinaArticleJsonLd()} />
      <SiteBreadcrumbs
        ...
        <div className="hs-container grid gap-10 py-10 sm:py-14 lg:grid-cols-12 lg:py-16">
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="eu_textile_dpp_article_hero"
          ...
          <Reveal className="lg:col-span-6" delayMs={120}>
            ...
            <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {['Supplier', 'Materials', 'Labels', 'Batch'].map((item) => (
                <a
          ...
          <article className="min-w-0 lg:col-span-8">
            <Reveal>
              ...
              <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
                What should apparel buyers check before goods ship?
              </h2>
              <p className="hs-muted mt-4 text-base leading-7">
                Check whether supplier identity, material composition, labels,
                certificates, batch records, carton evidence, and EU owner
                instructions can be tied to the exact textile goods before payment
                or pickup.
              </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="mt-1 text-3xl font-extrabold text-[var(--hs-text)]">
                    EU textile DPP supplier data checklist
                  </h2>
                </div>
              </div>
              <p className="hs-muted mt-4 text-base leading-7">
                The check is practical: map product and batch data, confirm supplier
                and facility roles, compare materials and labels, then package gaps
                for the EU owner before release.
              </p>
      ...
      <EvidenceDecisionMatrix
        id="decision-table"
        intro="Use this table to decide whether textile supplier data is ready enough for deposit, final payment, specialist review, or a hold before pickup."
        rows={article.decisionRows}
        title="Turn DPP data gaps into a release decision."
      />

      <EvidenceBasisSection
        className="hs-section-white"
        intro="This guide is based on official EU ESPR, Commission working-plan, and JRC textile DPP source context, then narrowed to supplier identity, product, material, label, batch, and shipment evidence that can be checked before goods leave China."
      ...
      <section className="hs-section-soft" id="source-notes">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Verify the EU direction, then document the shipment file.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              These sources explain the ESPR framework, textile priority status,
              and current DPP study context. They do not replace product-specific
              EU legal, compliance, customs, or marketplace advice.
            </p>
          </Reveal>
        ...
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-5 text-3xl font-extrabold text-[var(--hs-text)]">
              What to send before the data check.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Send product, supplier, material, label, certificate, carton, and
              importer instructions so the report can compare China-side facts
              against the evidence the EU team expects to use.
            </p>
          </Reveal>
      ...
      <section className="hs-section-soft" id="red-flags">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-5 text-3xl font-extrabold text-[var(--hs-text)]">
              Textile data red flags before payment or pickup.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Pause when supplier roles, materials, certificates, labels, batch
              IDs, cartons, and EU responsibility cannot be tied to the same order.
            </p>
          </Reveal>
          <Reveal className="lg:col-span-8">
      ...
      <section className="hs-section-white" id="scope-limits">
        <div className="hs-container hs-section max-w-4xl">
          <Reveal>
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              A China-side check is not an EU DPP compliance decision.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              The report can show what was visible, provided, and inconsistent before
              shipment. It cannot decide final ESPR scope, passport content,
              sustainability claim legality, or EU market acceptance.
            </p>
      ...
      <section className="hs-section-soft">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Connect textile data to label, packaging, and supplier control.
            </h2>
          </Reveal>
          <div className="grid gap-3 md:grid-cols-2 lg:col-span-8">
          ...
          <Reveal className="hs-cta-band px-6 py-10 text-white sm:px-10 lg:flex lg:items-center lg:justify-between lg:gap-10">
            <div className="relative">
              <div className="flex items-center gap-2 text-sm font-extrabold text-red-200">
                <Globe2 aria-hidden className="size-4" /> Before EU-bound textile goods leave China
              </div>
              <h2 className="mt-3 text-3xl font-extrabold">
                Check supplier identity, material records, labels, certificates, and batch evidence while correction is still practical.
              </h2>
              <p className="mt-3 max-w-2xl text-base leading-7 text-slate-300">
                Send product files, material details, certificates, label artwork,
                carton records, and release deadlines before final shipment approval.
              </p>
            </div>
            <ContactAgentButton
              analyticsLabel={article.primaryCta.label}
              analyticsLocation="eu_textile_dpp_article_final"
