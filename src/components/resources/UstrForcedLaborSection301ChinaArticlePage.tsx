...
import {
  makeUstrForcedLaborSection301ChinaArticleJsonLd,
  ustrForcedLaborSection301ChinaArticle,
} from '@/lib/ustr-forced-labor-section-301-china-2026-article'
...
export function UstrForcedLaborSection301ChinaArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makeUstrForcedLaborSection301ChinaArticleJsonLd()} />
      <SiteBreadcrumbs
        ...
        <div className="hs-container grid gap-10 py-10 sm:py-14 lg:grid-cols-12 lg:py-16">
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="ustr_forced_labor_section_301_article_hero"
          ...
          <Reveal className="lg:col-span-6" delayMs={120}>
            ...
            <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {['Proposal', 'Supplier', 'Origin', 'Handoff'].map((item) => (
                <a
          ...
          <article className="min-w-0 lg:col-span-8">
            <Reveal>
              ...
              <p className="hs-muted mt-4 text-base leading-7">
                Check whether proposal ownership, supplier identity, production
                site, product details, origin facts, material chain, forced-labor
                notes, and importer handoff can be tied to the exact goods before
                payment or pickup.
              </p>
            ...
            <Reveal as="section" className="mt-12 scroll-mt-24" id="ustr-checklist">
              ...
              <p className="hs-muted mt-4 text-base leading-7">
                The check is practical: identify who owns the proposal response,
                verify the supplier and product file, then separate visible China-side
                evidence from tariff, customs, and legal conclusions.
              </p>
      ...
      <EvidenceDecisionMatrix
        id="decision-table"
        intro="Use this table to decide whether China-side evidence is ready enough for deposit, final payment, specialist review, or a hold before pickup."
        rows={article.decisionRows}
        title="Turn proposed-duty and forced-labor gaps into a release decision."
      />

      <EvidenceBasisSection
        className="hs-section-white"
        intro="This guide is based on official USTR, Federal Register, CBP, and DHS source context, then narrowed to supplier identity, product, origin, material, and importer-handoff evidence that can be checked before goods leave China."
      ...
      <section className="hs-section-soft" id="source-notes">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Verify the proposal, then document the shipment file.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              These sources explain the USTR proposal, Section 301 process, comment
              timing, and forced-labor enforcement context. They do not replace
              product-specific customs, broker, tariff, compliance, or legal advice.
            </p>
          </Reveal>
        ...
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-5 text-3xl font-extrabold text-[var(--hs-text)]">
              What to send before the evidence check.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Send names, order files, material notes, tariff instructions, and
              importer guidance so the report can compare China-side facts against
              the evidence the U.S. team expects to use.
            </p>
          </Reveal>
      ...
      <section className="hs-section-soft" id="red-flags">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-5 text-3xl font-extrabold text-[var(--hs-text)]">
              Supplier-chain red flags before payment or pickup.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Pause when proposal ownership, supplier names, production site,
              product identity, material chain, and importer responsibility cannot
              be tied to the same order.
            </p>
          </Reveal>
          <Reveal className="lg:col-span-8">
      ...
      <section className="hs-section-white" id="scope-limits">
        <div className="hs-container hs-section max-w-4xl">
          <Reveal>
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              A China-side check is not a U.S. tariff or legal decision.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              The report can show what was visible, provided, and inconsistent before
              shipment. It cannot decide whether proposed duties apply, whether goods
              are admissible, or whether a supplier chain is free of forced labor.
            </p>
      ...
      <section className="hs-section-soft">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Connect supplier evidence to tariff and shipment control.
            </h2>
          </Reveal>
          <div className="grid gap-3 md:grid-cols-2 lg:col-span-8">
          ...
          <Reveal className="hs-cta-band px-6 py-10 text-white sm:px-10 lg:flex lg:items-center lg:justify-between lg:gap-10">
            <div className="relative">
              <div className="flex items-center gap-2 text-sm font-extrabold text-red-200">
                <Globe2 aria-hidden className="size-4" /> Before U.S.-bound goods leave China
              </div>
              <h2 className="mt-3 text-3xl font-extrabold">
                Check supplier identity, product facts, origin evidence, and importer handoff while correction is still practical.
              </h2>
              <p className="mt-3 max-w-2xl text-base leading-7 text-slate-300">
                Send the supplier names, order files, material notes, tariff
                instructions, carton records, and release deadline before final
                shipment approval.
              </p>
            </div>
            <ContactAgentButton
              analyticsLabel={article.primaryCta.label}
              analyticsLocation="ustr_forced_labor_section_301_article_final"
