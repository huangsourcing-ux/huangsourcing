...
import {
  portableFuelContainerChecksChinaArticle,
  makePortableFuelContainerChecksChinaArticleJsonLd,
} from '@/lib/portable-fuel-container-checks-china-article'
...
export function PortableFuelContainerChecksChinaArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makePortableFuelContainerChecksChinaArticleJsonLd()} />
      <SiteBreadcrumbs
        ...
        <div className="hs-container grid gap-10 py-10 sm:py-14 lg:grid-cols-12 lg:py-16">
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="portable_fuel_container_checks_china_article_hero"
          ...
          <Reveal className="lg:col-span-6" delayMs={120}>
            ...
            <p className="hs-muted mt-3 text-xs leading-5">
              Neutral AI-generated illustration of unbranded empty fuel containers,
              closure parts, a generic flame-mitigation insert, and inspection tools;
              not a product photograph, laboratory test, recalled product, or evidence
              from the cited public case.
            </p>
            <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {['Product route', 'Closure', 'Flame mitigation', 'Release'].map((item) => (
                <a
          ...
          <article className="min-w-0 lg:col-span-8">
            <Reveal>
              ...
              <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
                What should buyers check before portable fuel containers leave China?
              </h2>
              <p className="hs-muted mt-4 text-base leading-7">
                Classify the exact container before selecting evidence or inspection
                criteria. Match intended fuel, filled-versus-empty condition, capacity,
                material, closure, spout, seal, vent, flame-mitigation component,
                manufacturer, factory, model, production lot, labels, GCC support, and
                cartons. Hold any mismatch; do not treat a supplier video, ASTM name,
                UL logo, generic report, or improvised factory test as proof of child
                resistance, flame mitigation, or compliance.
              </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="mt-1 text-3xl font-extrabold text-[var(--hs-text)]">
                    Portable fuel container release checklist
                  </h2>
                </div>
              </div>
              <p className="hs-muted mt-4 text-base leading-7">
      ...
      <EvidenceDecisionMatrix
        id="decision-table"
        intro="Record the exact cleared container, capacity, closure, spout, flame-mitigation configuration, batch, cartons, and every open condition. A sampled visual pass must not conceal missing qualified evidence, a product-classification gap, a component or process change, failed units, unresolved certificate data, or an incomplete importer decision."
        rows={article.decisionRows}
        title="Turn portable fuel container evidence into a payment or shipment decision."
      />

      <EvidenceBasisSection
        className="hs-section-white"
        intro="This guide combines the August 2026 Deli Jerry recall, a separate same-day flame-mitigation recall, current CPSC business and GCC guidance, an independent 2026 packaging implementation notice, and buyer-side sourcing analysis. It keeps product classification, laboratory testing, certification, eFiling, inspection observations, importer duties, and release decisions in separate scopes."
      ...
      <section className="hs-section-soft scroll-mt-24" id="public-case">
        <div className="hs-container hs-section max-w-4xl">
          <Reveal>
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Deli Jerry: the closures were not child-resistant.
            </h2>
            <div className="hs-muted mt-4 grid gap-4 text-base leading-7">
              <p>
                <strong className="text-[var(--hs-text)]">What happened:</strong> On
                August 13, 2026, CPSC announced the recall of about 1,750 Deli Jerry
                fuel containers. CPSC said the closures were not child-resistant,
                creating burn and poisoning risks to children. The notice reported no
              ...
              <p>
                ...
                <a
                  className="hs-text-link"
                  href="https://www.cpsc.gov/Recalls/2026/Deli-Jerry-Fuel-Containers-Recalled-Due-to-Risk-of-Serious-Injury-or-Death-from-Burn-Hazard-and-Child-Poisoning-Violate-Mandatory-Standard-for-Portable-Fuel-Containers-Sold-on-Walmart-com-by-Deli-OfficeSupplies"
                  rel="noreferrer"
                  target="_blank"
                >
                  official CPSC recall
                </a>{' '}
                identifies dark-green metal containers in 20-, 25-, and 30-liter
                capacities, the brand and capacity marks, sales period, quantity,
                retailer in China, country of manufacture, incident status, and remedy.
                The notice does not publish complete drawings, bills of materials, test
                reports, closure geometry, component specifications, or factory controls.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">Buyer lesson:</strong>{' '}
                Freeze the intended fuel, fill condition, capacity, material, closure,
                spout, seal, vent, flame-mitigation device, manufacturer, factory,
                model, batch, test sample, reports, markings, GCC support, retail
                packages, and cartons. Keep sampled construction checks separate from
                product classification and prescribed performance testing.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">
                  Why the separate current case matters:
                </strong>{' '}
                The{' '}
                <a
                  className="hs-text-link"
                  href="https://www.cpsc.gov/Recalls/2026/Sunnyside-Corporation-Recalls-1-K-Kerosene-Heater-and-Appliance-Fuel-Containers-Due-to-Risk-of-Serious-Injury-or-Death-from-Flash-Fire-and-Burn-Hazard-Violates-Mandatory-Standards-for-Portable-Fuel-Containers"
                  rel="noreferrer"
                  target="_blank"
                >
                  August 2026 CPSC Sunnyside kerosene container recall
                </a>{' '}
                covered about 960 pre-filled kerosene containers that CPSC said lacked
                required flame-mitigation devices. It is a different product and party
                and does not prove a defect in Deli Jerry containers. It shows why the
                closure and flame-mitigation questions must be classified and evidenced
                separately rather than merged into a generic fuel-can checklist.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">
                  Limits of comparison:
                </strong>{' '}
                The records do not prove every portable fuel container, supplier,
                factory, or lot has the same defect, violation, or root cause. Huang
                Sourcing had no role in any cited case. A sampled buyer-side inspection
                cannot reproduce prescribed child-resistant packaging,
                flame-mitigation, flashback, endurance, chemical, pressure, leakage, or
                transport testing; issue a GCC; submit importer eFiling; or guarantee
                compliant or safe use.
              </p>
            </div>
          </Reveal>
        </div>
            ...
            <div className="grid gap-7 lg:grid-cols-12 lg:items-center">
              <div className="lg:col-span-8">
                ...
                <p className="mt-3 max-w-3xl text-base leading-7 text-white/80">
                  Share the exact models, capacities, approved construction file,
                  closure and spout drawings, flame-mitigation details, qualified
                  reports, GCC support, eFiling data map, labels, instructions, cartons,
                  change history, and deadline. Huang Sourcing can scope a practical
                  China-side comparison before balance payment or pickup.
                </p>
              </div>
              <div className="flex flex-col gap-3 lg:col-span-4">
                <ContactAgentButton
                  analyticsLabel="Check portable fuel containers before shipment"
                  analyticsLocation="portable_fuel_container_checks_china_article_final_cta"
        ...
        <div className="hs-container hs-section">
          <Reveal>
            ...
            <p className="hs-muted mt-3 max-w-3xl text-sm leading-6">
              Public records and official guidance checked August 20, 2026 Beijing time.
