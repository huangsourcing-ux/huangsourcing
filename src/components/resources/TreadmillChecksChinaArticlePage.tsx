...
import {
  cpscHorizonTreadmillRecall,
  cpscTreadmillSettlement,
  federalRegisterTreadmillSettlement,
  makeTreadmillChecksChinaArticleJsonLd,
  treadmillChecksChinaArticle,
} from '@/lib/treadmill-checks-china-article'
...
export function TreadmillChecksChinaArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makeTreadmillChecksChinaArticleJsonLd()} />
      <SiteBreadcrumbs
        ...
        <div className="hs-container grid gap-10 py-10 sm:py-14 lg:grid-cols-12 lg:py-16">
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="treadmill_checks_china_article_hero"
          ...
          <Reveal className="lg:col-span-6" delayMs={120}>
            ...
            <p className="hs-muted mt-3 text-xs leading-5">
              Neutral AI-generated illustration of an unbranded treadmill inspection;
              not a product photograph, test result, recalled unit, or evidence from the
              cited public case.
            </p>
            <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {['Exact version', 'Controls', 'Evidence', 'Release'].map((item) => (
                <a
          ...
          <article className="min-w-0 lg:col-span-8">
            <Reveal>
              ...
              <p className="hs-muted mt-4 text-base leading-7">
                Freeze the exact model, serial scheme, hardware, firmware, intended
                use, and market before selecting evidence or inspection criteria. Match
                the controller, motor, sensor, console, incline and stop systems, power
                connection, guards, labels, instructions, reports, lot, and cartons.
                Hold any mismatch. One unloaded demonstration, generic test report, or
                successful start-stop cycle cannot prove safe performance or compliance.
              </p>
            ...
            <Reveal as="section" className="mt-12 scroll-mt-24" id="release-checklist">
              ...
              <p className="hs-muted mt-4 text-base leading-7">
                Connect qualified design and test evidence to sampled mass production,
                incident history, changes, and pack-out. This checklist does not turn a
                routine no-load comparison into software, electrical, structural,
                endurance, loaded stopping, or compliance testing.
              </p>
      ...
      <EvidenceDecisionMatrix
        id="decision-table"
        intro="Record the exact cleared model, serial range, hardware, firmware, controls, stop system, power version, batch, accessories, cartons, and every open condition. A sampled visual or no-load functional pass must not conceal missing qualified evidence, a production change, failed units, complaint or incident data, or an incomplete responsible-party decision."
        rows={article.decisionRows}
        title="Turn treadmill evidence into a payment or shipment decision."
      />

      <EvidenceBasisSection
        className="hs-section-white"
        intro="This guide combines the August 2026 Johnson Health Tech settlement record, the underlying Horizon recall, two separate 2026 CPSC treadmill actions, the current ASTM F2115 scope page, independent industry coverage, and buyer-side sourcing analysis. It keeps legal reporting, engineering, laboratory testing, inspection observations, incident review, and shipment release in separate scopes."
      ...
      <section className="hs-section-soft scroll-mt-24" id="public-case">
        <div className="hs-container hs-section max-w-4xl">
          <Reveal>
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Horizon T101-05: changes, incidents, and release records stayed relevant.
            </h2>
            <div className="hs-muted mt-4 grid gap-4 text-base leading-7">
              <p>
                <strong className="text-[var(--hs-text)]">What happened:</strong> On
                August 4, 2026, CPSC announced a provisionally accepted $16.875 million
                settlement resolving staff charges that Johnson Health Tech Trading did
                not immediately report an alleged treadmill hazard. CPSC said the
                company had received at least 874 reports of unexpected acceleration,
                stopping, or speed changes, including at least 71 injury reports. The
                company did not admit the staff charges or a legal violation in the
                published agreement.
              </p>
              <p>
                ...
                <a
                  ...
                  target="_blank"
                >
                  CPSC settlement announcement
                </a>{' '}
                identifies staff charges, incident counts, production changes, the
                recall, and compliance-control terms. The{' '}
                <a
                  className="hs-text-link"
                  ...
                  target="_blank"
                >
                  Federal Register agreement
                </a>{' '}
                contains the company response, no-admission language, conditions, and
                continuing-control provisions. The{' '}
                <a
                  className="hs-text-link"
                ...
                identifies the T101-05, China and Vietnam serial prefixes, affected
                quantity, reported injuries, and USB software repair.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">Buyer lesson:</strong>{' '}
                Freeze exact model, origin-linked serial scheme, controller, firmware,
                motor, sensor, console, speed and stop behavior, approved changes,
                qualified evidence, production lot, inspection results, complaints,
                service actions, and cartons. A release record should remain usable if
                later events require version, serial-range, or affected-quantity review.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">
                  Limits of comparison:
                </strong>{' '}
                The records do not prove every treadmill, supplier, factory, firmware,
                controller, or lot has the same issue or root cause. Huang Sourcing had
                no role in the case. A sampled buyer-side inspection cannot reproduce
                prescribed loaded speed, stopping, software, thermal, electrical,
                structural, stability, endurance, accessibility, or entrapment tests;
                determine legal reporting; issue certifications; or guarantee safe use.
              </p>
            </div>
          </Reveal>
        </div>
        ...
        <div className="hs-container hs-section">
          <Reveal className="max-w-3xl">
            ...
            <p className="hs-muted mt-3 text-base leading-7">
              ...
              references, failed units, complaints, and unresolved changes should
              remain visible as open conditions, not be replaced by factory assumptions.
            </p>
          </Reveal>
            ...
            <div className="grid gap-7 lg:grid-cols-12 lg:items-center">
              <div className="lg:col-span-8">
                ...
                <p className="mt-3 max-w-3xl text-base leading-7 text-white/80">
                  Share exact models, serial ranges, hardware and firmware versions,
                  approved construction files, qualified reports, change and incident
                  records, labels, accessories, cartons, and deadline. Huang Sourcing
                  can scope a practical China-side comparison before balance payment or
                  pickup.
                </p>
              </div>
              <div className="flex flex-col gap-3 lg:col-span-4">
                <ContactAgentButton
                  analyticsLabel="Check treadmills before shipment"
                  analyticsLocation="treadmill_checks_china_article_final_cta"
        ...
        <div className="hs-container hs-section">
          <Reveal>
            ...
            <p className="hs-muted mt-3 max-w-3xl text-sm leading-6">
              Public records, current standards information, and independent coverage
              checked August 23, 2026 Beijing time. Links identify the exact products,
              allegations, company response, dates, actions, design topics, and limits
              used in this guide.
            </p>
