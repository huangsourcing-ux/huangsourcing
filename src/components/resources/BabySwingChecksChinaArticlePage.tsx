...
import {
  babySwingChecksChinaArticle,
  makeBabySwingChecksChinaArticleJsonLd,
} from '@/lib/baby-swing-checks-china-article'
...
export function BabySwingChecksChinaArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makeBabySwingChecksChinaArticleJsonLd()} />
      <SiteBreadcrumbs
        ...
        <div className="hs-container grid gap-10 py-10 sm:py-14 lg:grid-cols-12 lg:py-16">
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="baby_swing_checks_china_article_hero"
          ...
          <Reveal className="lg:col-span-6" delayMs={120}>
            ...
            <p className="hs-muted mt-3 text-xs leading-5">
              Neutral AI-generated illustration of a generic baby swing inspection
              setup; not a product photograph, laboratory test, recalled product, or
              evidence from the cited public case.
            </p>
            <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {['Exact model', 'Test scope', 'Lot check', 'Release'].map((item) => (
                <a
          ...
          <article className="min-w-0 lg:col-span-8">
            <Reveal>
              ...
              <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
                What should buyers check before baby swings leave China?
              </h2>
              <p className="hs-muted mt-4 text-base leading-7">
                Match the exact finished swing to qualified performance evidence and a
                controlled production file. Inspect the sampled lot for frame, feet,
                seat, restraints, strap routing, locks, drive components, identity,
                tracking, instructions, registration materials, packaging, quantities,
                and workmanship. Hold any mismatch; do not treat a supplier video,
                certificate image, or improvised load as proof of required stability,
                structural, folding, restraint, or strap-accessibility performance.
              </p>
      ...
      <EvidenceDecisionMatrix
        id="decision-table"
        intro="Record the exact cleared swing, product class, model, batch, and every open condition. A sampled visual pass must not conceal missing performance evidence, a design change, mixed production, failed units, unresolved labels, or an incomplete importer decision."
        rows={article.decisionRows}
        title="Turn baby swing evidence into a payment or shipment decision."
      />

      <EvidenceBasisSection
        className="hs-section-white"
        intro="This guide combines the August 2026 U.S. and Canadian Taleco Gear recall records, current official infant-swing and certificate guidance, recent industry context, and buyer-side sourcing analysis. It keeps product classification, mandatory testing, certificate and filing duties, inspection observations, and release decisions in separate scopes."
      ...
      <section className="hs-section-soft scroll-mt-24" id="public-case">
        <div className="hs-container hs-section max-w-4xl">
          <Reveal>
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Taleco Gear: one recalled group, several product configurations.
            </h2>
            <div className="hs-muted mt-4 grid gap-4 text-base leading-7">
              <p>
                <strong className="text-[var(--hs-text)]">What happened:</strong> On
                August 13, 2026, CPSC recalled a Taleco Gear group containing a baby
                jumper, a baby swing, and two 2-in-1 jumper-and-swing configurations.
                CPSC said the products could become unstable and that hanging restraint
                straps and seat openings could pose strangulation hazards. Across the
                recalled group, about 41,100 units were sold in the United States; the
                firm had received at least 52 hazard reports and at least 32 injury
                reports, including head bumps and a bloody nose.
              </p>
              <p>
                ...
                <a
                  className="hs-text-link"
                  href="https://www.cpsc.gov/Recalls/2026/Taleco-Gear-Recalls-Baby-Jumpers-Baby-Swings-and-2-in-1-Baby-Jumper-Swings-Due-to-Risk-of-Serious-Injury-or-Death-from-Fall-and-Strangulation-Hazards"
                  rel="noreferrer"
                  target="_blank"
                >
                  official CPSC recall
                </a>{' '}
                identifies the product names, model table, colors, sales channels,
                collective quantity, incident scope, remedy, importer, and China origin.
                The standalone swing is model swing-1, while jumper-01 appears on the
                jumper and 2-in-1 configurations. The notice does not publish complete
                drawings, bills of materials, test reports, root-cause analysis, or all
                factory controls.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">Buyer lesson:</strong>{' '}
                Do not let one commercial family name erase configuration differences.
                Freeze the exact product class, frame, feet, seat, restraints, hanging
                straps, openings, joints, locks, drive system, accessories, factory,
                model, batch, test sample, reports, labels, packages, and cartons. Keep
                sampled construction checks separate from qualified mandatory testing.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">
                  What the coordinated record adds:
                </strong>{' '}
                The{' '}
                <a
                  className="hs-text-link"
                  href="https://recalls-rappels.canada.ca/en/alert-recall/taleco-gear-2-1-jumper-swing-recalled-due-fall-and-strangulation-hazards"
                  rel="noreferrer"
                  target="_blank"
                >
                  Health Canada recall
                </a>{' '}
                narrows its scope to the black 2-in-1 Jumper &amp; Swing-A, model
                Jumper-01, identifies Shanxi Yida Technology Co., Ltd. in China as the
                manufacturer, and records 150 Canadian sales. It also preserves the
                collective U.S. incident scope while reporting no Canadian incidents as
                of July 28, 2026.
              </p>
              <p>
                <strong className="text-[var(--hs-text)]">
                ...
                The records do not prove every infant swing, combination product,
                supplier, factory, or lot has the same failure. The reported quantity and
                incidents cover the recalled group, not the standalone swing alone.
                Huang Sourcing had no role in the case. A sampled buyer-side inspection
                cannot reproduce prescribed performance testing, issue a compliance
                certificate, or guarantee safe use.
              </p>
            </div>
          </Reveal>
        </div>
            ...
            <div className="grid gap-7 lg:grid-cols-12 lg:items-center">
              <div className="lg:col-span-8">
                ...
                <p className="mt-3 max-w-3xl text-base leading-7 text-white/80">
                  ...
                  certificate data, tracking, registration materials, packages, carton
              ...
              <div className="flex flex-col gap-3 lg:col-span-4">
                <ContactAgentButton
                  analyticsLabel="Check baby swings before shipment"
                  analyticsLocation="baby_swing_checks_china_article_final_cta"
        ...
        <div className="hs-container hs-section">
          <Reveal>
            ...
            <p className="hs-muted mt-3 max-w-3xl text-sm leading-6">
              Public records, official guidance, and independent coverage checked August
              17, 2026 Beijing time. Links identify the exact products, findings, dates,
              actions, requirements, and interpretation limits used in this guide.
            </p>
