...
import {
  euCyberResilienceActChinaArticle,
  makeEuCyberResilienceActChinaArticleJsonLd,
} from '@/lib/eu-cyber-resilience-act-china-sourcing-2026-article'
...
export function EuCyberResilienceActChinaArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makeEuCyberResilienceActChinaArticleJsonLd()} />
      <SiteBreadcrumbs
          ...
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="eu_cyber_resilience_article_hero"
      ...
      <section className="hs-section-white" id="quick-answer">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          ...
          <article className="min-w-0 lg:col-span-8">
            ...
            <Reveal as="section" className="mt-12 scroll-mt-24" id="cra-checklist">
              ...
              <p className="hs-muted mt-4 text-base leading-7">
                The check connects the real device, labels, manuals, firmware, app,
                packaging, CE file, and responsible-party handoff to the goods that
      ...
      <EvidenceDecisionMatrix
        id="decision-table"
        intro="Use this table to decide whether connected-product evidence is ready enough for deposit, final payment, specialist review, or a hold before pickup."
        rows={article.decisionRows}
        title="Turn CRA evidence gaps into a release decision."
      />

      <EvidenceBasisSection
        className="hs-section-white"
        intro="This guide is based on official EU and ENISA source context, then narrowed to device identity, software version, label, CE, support-period, and importer-handoff evidence that can be checked before goods leave China."
      ...
      <section className="hs-section-white" id="documents">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <p className="hs-muted mt-3 text-base leading-7">
              Send product identity, software version, label, manual, CE, technical
              file, supplier, and EU-side responsibility records so the report can
              compare China-side facts against the file the responsible party expects
              to use.
            </p>
          </Reveal>
      ...
      <section className="hs-section-soft" id="red-flags">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <p className="hs-muted mt-3 text-base leading-7">
              Pause when model, firmware, app, cloud, CE, manual, support-period,
              or reporting ownership evidence cannot be tied to the same shipment lot.
            </p>
          </Reveal>
          <Reveal className="lg:col-span-8">
      ...
      <section className="hs-section-white" id="scope-limits">
        <div className="hs-container hs-section max-w-4xl">
          <Reveal>
            ...
            <p className="hs-muted mt-3 text-base leading-7">
              The report can show what was visible, provided, missing, and
              inconsistent before shipment. It cannot certify cybersecurity
              compliance or decide whether EU authorities, notified bodies,
              marketplaces, or buyers will accept the file.
            </p>
      ...
      <section className="hs-section-soft">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Connect CRA evidence to labels, QC, and shipment release.
            </h2>
          </Reveal>
          <div className="grid gap-3 md:grid-cols-2 lg:col-span-8">
          ...
          <Reveal className="hs-cta-band px-6 py-10 text-white sm:px-10 lg:flex lg:items-center lg:justify-between lg:gap-10">
            <div className="relative">
              <div className="flex items-center gap-2 text-sm font-extrabold text-red-200">
                <Globe2 aria-hidden className="size-4" /> Before EU-bound connected
                goods leave China
              </div>
              ...
              <p className="mt-3 max-w-2xl text-base leading-7 text-slate-300">
                ...
                CE documents, EU handoff notes, and shipment deadline before final
                release.
              </p>
            </div>
            <ContactAgentButton
              analyticsLabel={article.primaryCta.label}
              analyticsLocation="eu_cyber_resilience_article_final"
