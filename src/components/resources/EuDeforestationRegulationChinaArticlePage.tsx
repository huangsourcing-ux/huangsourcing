...
import {
  euDeforestationRegulationChinaArticle,
  makeEuDeforestationRegulationChinaArticleJsonLd,
} from '@/lib/eu-deforestation-regulation-china-sourcing-2026-article'
...
export function EuDeforestationRegulationChinaArticlePage() {
  ...
  return (
    <main className="hs-page min-h-screen overflow-x-clip antialiased">
      ...
      <JsonLd data={makeEuDeforestationRegulationChinaArticleJsonLd()} />
      <SiteBreadcrumbs
        ...
        <div className="hs-container grid gap-10 py-10 sm:py-14 lg:grid-cols-12 lg:py-16">
          <Reveal className="min-w-0 lg:col-span-6">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ContactAgentButton
                ...
                analyticsLocation="eu_deforestation_regulation_article_hero"
          ...
          <Reveal className="lg:col-span-6" delayMs={120}>
            ...
            <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {['Scope', 'Origin', 'Geo', 'Release'].map((item) => (
                <a
          ...
          <article className="min-w-0 lg:col-span-8">
            <Reveal>
              ...
              <p className="hs-muted mt-4 text-base leading-7">
                Check whether the exact product is in EUDR scope, whether the
                relevant commodity origin and supplier chain are traceable, whether
                geolocation and legality files are available, and whether the EU
                responsible party accepts the evidence before cartons leave China.
              </p>
            ...
            <Reveal as="section" className="mt-12 scroll-mt-24" id="eudr-checklist">
              ...
              <p className="hs-muted mt-4 text-base leading-7">
                The check is practical: scope the product, follow the material chain,
                preserve supplier traceability, and package the evidence for the
                EU-side owner before shipment release.
              </p>
      ...
      <EvidenceDecisionMatrix
        id="decision-table"
        intro="Use this table to decide whether EUDR evidence is ready enough for deposit, final payment, supplier correction, specialist review, or a hold before pickup."
        rows={article.decisionRows}
        title="Turn EUDR evidence into a payment or shipment decision."
      />

      <EvidenceBasisSection
        className="hs-section-white"
        intro="This guide is based on official EU EUDR source context, then narrowed to product scope, supplier chain, traceability, geolocation, legality, document, and importer-handoff evidence that can be checked while goods are still in China."
      ...
      <section className="hs-section-soft" id="source-notes">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Verify the rule, then check the supplier file.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              These sources explain EUDR scope, timelines, guidance, country
              benchmarking, traceability, and due diligence. They do not replace
              shipment-specific legal or compliance advice.
            </p>
          </Reveal>
        ...
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-5 text-3xl font-extrabold text-[var(--hs-text)]">
              What to send before the EUDR evidence check.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Send product scope notes, supplier files, upstream material records,
              geolocation evidence, shipment paperwork, and release rules before
              the China-side check starts.
            </p>
          </Reveal>
      ...
      <section className="hs-section-soft" id="red-flags">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-5 text-3xl font-extrabold text-[var(--hs-text)]">
              EUDR evidence red flags before payment.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              Pause deposit, balance payment, or pickup when supplier documents,
              product scope, material origin, and EU responsibility do not line up.
            </p>
          </Reveal>
          <Reveal className="lg:col-span-8">
      ...
      <section className="hs-section-white" id="scope-limits">
        <div className="hs-container hs-section max-w-4xl">
          <Reveal>
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              A China-side check is not an EUDR due-diligence decision.
            </h2>
            <p className="hs-muted mt-3 text-base leading-7">
              The report can show what was visible, provided, missing, corrected,
              and inconsistent before shipment. It cannot decide legal scope,
              submit declarations, validate geolocation, or guarantee EU market
              access.
            </p>
      ...
      <section className="hs-section-soft">
        <div className="hs-container hs-section grid gap-8 lg:grid-cols-12">
          <Reveal className="lg:col-span-4">
            ...
            <h2 className="mt-3 text-3xl font-extrabold text-[var(--hs-text)]">
              Connect EUDR evidence to supplier, packaging, and shipment control.
            </h2>
          </Reveal>
          <div className="grid gap-3 md:grid-cols-2 lg:col-span-8">
          ...
          <Reveal className="hs-cta-band px-6 py-10 text-white sm:px-10 lg:flex lg:items-center lg:justify-between lg:gap-10">
            <div className="relative">
              <div className="flex items-center gap-2 text-sm font-extrabold text-red-200">
                <Globe2 aria-hidden className="size-4" /> Before EUDR assumptions lock in
              </div>
              <h2 className="mt-3 text-3xl font-extrabold">
                Check product scope, material origin, supplier files, and EU handoff while correction is still practical.
              </h2>
              <p className="mt-3 max-w-2xl text-base leading-7 text-slate-300">
                Send the SKU list, supplier names, material records, traceability
                files, shipment paperwork, and release deadline before final
                shipment approval.
              </p>
            </div>
            <ContactAgentButton
              analyticsLabel={article.primaryCta.label}
              analyticsLocation="eu_deforestation_regulation_article_final"
